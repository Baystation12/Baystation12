...
//Military RT//
/obj/item/clothing/head/helmet/soldier
	name = "soldier's helmet"
	icon_state = "military_soldier_helmet"

/obj/item/clothing/head/helmet/soldier/engineer
	name = "engineer's helmet"
	icon_state = "military_engineer_helmet"

/obj/item/clothing/head/helmet/soldier/medic
	name = "medic's helmet"
	icon_state = "military_medic_helmet"

//Unitologist RT//
/obj/item/clothing/head/helmet/unitologist
	name = "faithful's helmet"
	icon_state = "unitologist_faithful_helmet"

/obj/item/clothing/head/helmet/unitologist/healer
	name = "healer's helmet"
	icon_state = "unitologist_healer_helmet"

/obj/item/clothing/head/helmet/unitologist/mechanic
	name = "mechanic's helmet"
	icon_state = "unitologist_mechanic_helmet"

/obj/item/clothing/head/helmet/unitologist/berserker
	name = "berserker's helmet"
	icon_state = "unitologist_berserker_helmet"

/obj/item/clothing/head/helmet/unitologist/deacon
	name = "deacon's helmet"
	icon_state = "unitologist_deacon_helmet"

//Misc//
/obj/item/clothing/head/helmet/vintage
	name = "heavy duty helmet"
