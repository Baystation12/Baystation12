...
/datum/sprite_accessory/hair/taj
	...
	icon = 'mods/tajara/icons/tajara_body/sprite_accessory/hair.dmi'
...
/datum/sprite_accessory/marking/taj
	...
	icon = 'mods/tajara/icons/tajara_body/sprite_accessory/markings.dmi'
...
/datum/sprite_accessory/skin/tajaran
	...
	icon_state = "default"
	icon = 'mods/tajara/icons/tajara_body/body.dmi'
	species_allowed = list(SPECIES_TAJARA)
