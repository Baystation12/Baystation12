...
/obj/item/clothing/shoes/magboots/rig/medical/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_TAJARA, 'mods/tajara/icons/sprite_sheets/feet.dmi')
...
/obj/item/clothing/shoes/taj_old_shoes
	...
	icon = 'mods/tajara/icons/shoes.dmi'
	item_icons = list(slot_shoes_str = 'mods/tajara/icons/onmob_feet.dmi')
