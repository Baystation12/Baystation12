...
/obj/machinery/computer/rust/gyrotron_controller/New()
	..()

/obj/machinery/computer/rust/gyrotron_controller/attack_ai(mob/user)
	attack_hand(user)

/obj/machinery/computer/rust/gyrotron_controller/attack_hand(mob/user)
	add_fingerprint(user)
	/*if(stat & (BROKEN|NOPOWER))
		return*/
	interact(user)

/*/obj/machinery/computer/rust/gyrotron_controller/updateDialog()
	for(var/mob/M in range(1))
		if(M.machine == src)
			interact(m)*/

/obj/machinery/computer/rust/gyrotron_controller/Topic(href, href_list)
	..()
	if( href_list["close"] )
...
/obj/machinery/computer/rust/gyrotron_controller/process()
	..()
	if(updating)
		src.updateDialog()

/obj/machinery/computer/rust/gyrotron_controller/interact(mob/user)
