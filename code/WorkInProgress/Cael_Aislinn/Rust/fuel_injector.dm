...
/obj/machinery/rust/fuel_injector/New()
	..()
...
/obj/machinery/rust/fuel_injector/Topic(href, href_list)
	..()
	if( href_list["close"] )
...
/obj/machinery/rust/fuel_injector/attack_ai(mob/user)
	attack_hand(user)

/obj/machinery/rust/fuel_injector/attack_hand(mob/user)
	add_fingerprint(user)
	/*if(stat & (BROKEN|NOPOWER))
		return*/
	interact(user)

/obj/machinery/rust/fuel_injector/interact(mob/user)
...
/obj/machinery/rust/fuel_injector/proc/BeginInjecting()
...
/obj/machinery/rust/fuel_injector/proc/StopInjecting()
	if(injecting)
		injecting = 0
		icon_state = "injector0"
		return 1
...
/obj/machinery/rust/fuel_injector/proc/Inject()
	if(!injecting)
		return
...
/obj/machinery/rust/fuel_injector/process()
	..()
	updateDialog()
	//
