...
/obj/machinery/computer/rust/energy_monitor/New()
	..()
	spawn(0)
		core_generator = locate() in world

/obj/machinery/computer/rust/energy_monitor/attack_ai(mob/user)
	attack_hand(user)

/obj/machinery/computer/rust/energy_monitor/attack_hand(mob/user)
	add_fingerprint(user)
	if(stat & (BROKEN|NOPOWER))
		return
	interact(user)

/obj/machinery/computer/rust/energy_monitor/Topic(href, href_list)
	..()
...
/obj/machinery/computer/rust/energy_monitor/process()
	..()
	if(updating)
		src.updateDialog()

/obj/machinery/computer/rust/energy_monitor/interact(mob/user)
