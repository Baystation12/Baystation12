...
/obj/machinery/computer/rust/fuel_control/New()
	..()
...
/obj/machinery/computer/rust/fuel_control/attack_ai(mob/user)
	attack_hand(user)

/obj/machinery/computer/rust/fuel_control/attack_hand(mob/user)
	add_fingerprint(user)
	/*if(stat & (BROKEN|NOPOWER))
		return*/
	interact(user)

/*/obj/machinery/computer/rust/fuel_control/updateDialog()
	for(var/mob/M in range(1))
		if(M.machine == src)
			interact(m)*/

/obj/machinery/computer/rust/fuel_control/Topic(href, href_list)
	..()
	if( href_list["close"] )
...
/obj/machinery/computer/rust/fuel_control/process()
	..()
	src.updateDialog()

/obj/machinery/computer/rust/fuel_control/interact(mob/user)
