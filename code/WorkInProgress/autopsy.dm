	...
	for(var/wdata_idx in wdata)
		...
		switch(total_score)
			if(0)
				damage_desc = "Unknown"
			if(1 to 5)
				damage_desc = "<font colour='green'>negligible</font>"
			if(5 to 15)
				damage_desc = "<font colour='green'>light</font>"
			if(15 to 30)
				damage_desc = "<font colour='orange'>moderate</font>"
			if(30 to 1000)
				damage_desc = "<font colour='red'>severe</font>"
