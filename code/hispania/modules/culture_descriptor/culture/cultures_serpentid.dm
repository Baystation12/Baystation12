...
/decl/cultural_info/culture/nabber
	...
	description = "Usted ha sido entrenado por Xynergy al Grado PLACEHOLDER."
...
/decl/cultural_info/culture/nabber/New()
	...
	if(!LAZYLEN(job_titles))
		LAZYADD(job_titles, "ninguno")
	description = "Has sido entrenado por Xynergy, [name]. Esto te hace apto para los siguientes roles: [english_list(job_titles)]."

	// Set up our qualifications.
	LAZYADD(qualifications, "<b>[name]</b>")
	for(var/role in job_titles)
		LAZYADD(qualifications, "Seguro para [role].")
