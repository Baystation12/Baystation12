...
/decl/hierarchy/skill
	...
	var/levels = list( 		"No capacitado"			= "No capacitado Descripcion",
...
/decl/hierarchy/skill/organizational/bureaucracy
	...
	levels = list( "No capacitado"			= "Por lo general, puede completar el papeleo basico, aunque con algunos errores. Tiene un conocimiento vago de la ley, obtenido principalmente de las noticias y la experiencia personal.",
...
/decl/hierarchy/skill/general/EVA/mech
	...
	levels = list("no entrenado" = "No esta familiarizado con los controles del exotraje y, si intenta usarlos, es probable que cometa errores.",
...
/decl/hierarchy/skill/service/botany
	...
	levels = list( "No capacitado"			= "No sabes casi nada acerca de las plantas. Si bien puedes intentar plantar, desyerbar o cosechar, es muy probable que mates la planta en su lugar.",
...
/decl/hierarchy/skill/service/cooking
	...
	levels = list( "No capacitado"			= "Apenas sabes nada de cocina y te limitas a las maquinas expendedoras cuando puedes. El microondas es un dispositivo de magia negra para ti, y lo evitas cuando es posible.",
...
/decl/hierarchy/skill/security/forensics
	...
	levels = list( "No capacitado"			= "Sabes que los detectives resuelven crimenes. Puede que tengas alguna idea de que es malo contaminar la escena del crimen, pero no tienes muy claros los detalles.",
...
/decl/hierarchy/skill/research/devices
	...
	levels = list( "No capacitado"			= "Sabes como usar la tecnologia que estaba presente en cualquier sociedad en la que creciste. Sabes como saber cuando algo funciona mal, pero tienes que llamar al soporte tecnico para que lo arreglen.",
...
/decl/hierarchy/skill/research/science
	...
	levels = list( "No capacitado"			= "Sabes lo que es la ciencia y probablemente tengas una vaga idea del metodo cientifico de tus clases de ciencias de la escuela secundaria.",
...
/decl/hierarchy/skill/medical/anatomy
	...
	levels = list( "No capacitado"			= "Sabes que son los organos, los huesos y demas, y sabes aproximadamente donde estan. Sabes que alguien que esta gravemente herido o enfermo puede necesitar cirugia.",
...
/decl/hierarchy/skill/medical/chemistry
	...
	levels = list( "No capacitado"			= "Sabes que los quimicos trabajan con quimicos; sabes que pueden hacer medicinas, venenos o quimicos utiles. Probablemente sepas que es un elemento y tengas una vaga idea de lo que es una reaccion quimica alguna clase de quimica en tus dias de escuela secundaria.",
