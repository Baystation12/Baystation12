...
/mob/new_player/proc/deferred_login()
	if(client)
		...
		maybe_send_staffwarns("Conectado como nuevo jugador")
	...
	to_chat(src, "<span class='notice'>El nivel de alerta en la [station_name()] es actualmente: <font color=[SL.light_color_alarm]><B>[SL.name]</B></font>. [alert_desc]</span>")
