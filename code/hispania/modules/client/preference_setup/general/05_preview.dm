...
/datum/category_item/player_setup_item/physical/preview/content(mob/user)
	...
	. = "<b>Preview:</b>"
	. += "<br />[BTN("cyclebg", "Cambiar el fondo")]"
	. += " - [BTN("previewgear", "[pref.preview_gear ? "Ocultar" : "Show"] equipamiento")]"
	. += " - [BTN("previewjob", "[pref.preview_job ? "Ocultar" : "Show"] uniforme")]"
