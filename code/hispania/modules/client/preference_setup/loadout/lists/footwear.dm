...
/datum/gear/shoes/athletic
	display_name = "calzado deportivo, seleccione color"
	path = /obj/item/clothing/shoes/athletic
	flags = GEAR_HAS_COLOR_SELECTION

/datum/gear/shoes/boots
	display_name = "seleccion de botas"
...
/datum/gear/shoes/color
	display_name = "seleccion de zapatos"
	path = /obj/item/clothing/shoes
...
/datum/gear/shoes/flats
	display_name = "zapatos bajos, seleccione color"
	path = /obj/item/clothing/shoes/flats
	flags = GEAR_HAS_COLOR_SELECTION

/datum/gear/shoes/high
	display_name = "selección de tops altos"
...
/datum/gear/shoes/heels
	display_name = "tacones altos, seleccione color"
	path = /obj/item/clothing/shoes/heels
	flags = GEAR_HAS_COLOR_SELECTION

/datum/gear/shoes/foamclog
	display_name = "zuecos de espuma"
