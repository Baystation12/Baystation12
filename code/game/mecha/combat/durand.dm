...
/obj/mecha/combat/durand/relaymove(mob/user,direction)
	if(defence)
		if(world.time - last_message > 20)
			src.occupant_message("<font colour='red'>Unable to move while in defence mode</font>")
...
/obj/mecha/combat/durand/verb/defence_mode()
	...
	if(defence)
		...
		src.occupant_message("<font colour='blue'>You enable [src] defence mode.</font>")
	else
		deflect_chance = initial(deflect_chance)
		src.occupant_message("<font colour='red'>You disable [src] defence mode.</font>")
