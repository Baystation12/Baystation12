	...
	for(var/mob/living/player in player_list)
		if(player.stat != DEAD)
			...
			switch(location.loc.type)
				...
				if( /area/shuttle/escape_pod1/centcom, /area/shuttle/escape_pod2/centcom, /area/shuttle/escape_pod3/centcom, /area/shuttle/escape_pod5/centcom, /area/shuttle/escape_pod_medical/centcom )
