...
/datum/game_mode/epidemic/send_intercept()
	var/intercepttext = "<FONT size = 3 colour='red'><B>CONFIDENTIAL REPORT</FONT><HR>"
	...
	intercepttext += "<BR><B><FONT size = 2 colour='blue'>Instructions</FONT></B><BR>"
