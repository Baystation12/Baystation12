...
/datum/game_mode/revolution/rp_revolution/process()
	...
	else if(last_command_report == 1 && world.time >= 10 * 60 * 20)
	...
	else if(last_command_report == 2 && world.time >= 10 * 60 * 40)
...
/datum/game_mode/revolution/rp_revolution/proc/command_report(message)
	...
	command_announcement.Announce(message, "Central Command Announcement");
