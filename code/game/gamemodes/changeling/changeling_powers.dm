...
/mob/proc/sting_can_reach(mob/M as mob, sting_range = 1)
	...
	if(!AStar(src.loc, M.loc, /turf::AdjacentTurfs(), /turf::Distance(), max_nodes=25, max_node_depth=sting_range)) //If we can't find a path, fail
...
/mob/proc/changeling_lsdsting()
	...
	var/mob/living/carbon/human/T = changeling_sting(15, /mob::changeling_lsdsting(), sting_name = "Hallucination Sting")
	if(!T)	return 0
	spawn(rand(300,600))
...
/mob/proc/changeling_silence_sting()
	...
	var/mob/living/carbon/human/T = changeling_sting(10, /mob::changeling_silence_sting(), sting_name = "Silence Sting")
	if(!T)	return 0
	T.silent += 30
	return 1
...
/mob/proc/changeling_blind_sting()
	...
	var/mob/living/carbon/human/T = changeling_sting(20, /mob::changeling_blind_sting(), sting_name = "Blind Sting")
	if(!T)	return 0
...
/mob/proc/changeling_deaf_sting()
	...
	var/mob/living/carbon/human/T = changeling_sting(5, /mob::changeling_deaf_sting(), sting_name = "Deaf Sting")
	if(!T)	return 0
...
/mob/proc/changeling_DEATHsting()
	...
	var/mob/living/carbon/human/T = changeling_sting(40, /mob::changeling_DEATHsting(),loud, sting_name = "Death Sting")
	if(!T)	return 0
...
/mob/proc/changeling_extract_dna_sting()
	...
	var/mob/living/carbon/human/T = changeling_sting(40, /mob::changeling_extract_dna_sting(), sting_name = "Extract DNA Sting")
	if(!T)	return 0
