...
/mob/living/cultify()
	if(iscultist(src) && client)
		...
		to_chat(G, SPAN_OCCULT("You feel relieved as what's left of your soul finally escapes its prison of flesh."))
	else
		dust()
