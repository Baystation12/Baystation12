...
/obj/item/orion_ship/attack_self(mob/user)
	...
	src.audible_message("<b>\The [src]</b> говорит, 'This is ship ID #[rand(1,1000)] to Orion Port Authority. We're coming in for landing, over.'")
	sleep(20)
	src.visible_message("<span class='warning'>[src] begins to vibrate...</span>")
	src.audible_message("<b>\The [src]</b> говорит, 'Uh, Port? Having some issues with our reactor, could you check it out? Over.'")
	sleep(30)
	src.audible_message("<b>\The [src]</b> говорит, 'Oh, God! Code Eight! CODE EIGHT! IT'S GONNA BL-'")
	sleep(3.6)
