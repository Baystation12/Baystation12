...
/*			if ("Search Fingerprints")
			...
			if ("Print Record")
				if (!( printing ))
					...
					if (record2)
						P.info += text("<BR>\n<CENTER><B>Security Data</B></CENTER><BR>\nCriminal Status: []<BR>\n<BR>\nMinor Crimes: []<BR>\nDetails: []<BR>\n<BR>\nMajor Crimes: []<BR>\nDetails: []<BR>\n<BR>\nImportant Notes:<BR>\n\t[]<BR>\n<BR>\n<CENTER><B>Comments/Log</B></CENTER><BR>", record2.fields["criminal"], sanitize_u(record2.fields["mi_crim"]), sanitize_u(record2.fields["mi_crim_d"]), sanitize_u(record2.fields["ma_crim"]), sanitize_u(record2.fields["ma_crim_d"]), sanitize_u(decode(record2.fields["notes"])))
						var/counter = 1
