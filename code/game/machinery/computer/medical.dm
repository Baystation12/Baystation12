		...
		if (src.authenticated)
			...
			if (href_list["print_p"])
				if (!( src.printing ))
					...
					if (record2)
						P.info += text("<BR>\n<CENTER><B>Medical Data</B></CENTER><BR>\nBlood Type: []<BR>\nDNA: []<BR>\n<BR>\nMinor Disabilities: []<BR>\nDetails: []<BR>\n<BR>\nMajor Disabilities: []<BR>\nDetails: []<BR>\n<BR>\nAllergies: []<BR>\nDetails: []<BR>\n<BR>\nCurrent Diseases: [] (per disease info placed in log/comment section)<BR>\nDetails: []<BR>\n<BR>\nImportant Notes:<BR>\n\t[]<BR>\n<BR>\n<CENTER><B>Comments/Log</B></CENTER><BR>", record2.fields["b_type"], record2.fields["b_dna"], sanitize_u(record2.fields["mi_dis"]), sanitize_u(record2.fields["mi_dis_d"]), sanitize_u(record2.fields["ma_dis"]), sanitize_u(record2.fields["ma_dis_d"]), record2.fields["alg"], record2.fields["alg_d"], record2.fields["cdi"], record2.fields["cdi_d"], sanitize_u(decode(record2.fields["notes"])))
						var/counter = 1
