...
/datum/data/record/proc/print_med_top(var/user)
	var/dat
	var/icon/front = fields["photo_front"]
	var/icon/side = fields["photo_side"]
	send_rsc(user, front, "front.png")
	send_rsc(user, side, "side.png")
	dat += "<CENTER><B>Medical Record</B></CENTER><BR>"
	if(GLOB.data_core.general.Find(src))
		dat += "<table><tr><td>\
			Name: [fields["name"]]<BR>\n\
			ID: [fields["id"]]<BR>\n\
			Species: <A href='?src=\ref[src];field=sex'>[fields["species"]]</A><BR>\n\
			Sex: <A href='?src=\ref[src];field=sex'>[fields["sex"]]</A><BR>\n\
			Age: <A href='?src=\ref[src];field=age'>[fields["age"]]</A><BR>\n\
			Fingerprint: <A href='?src=\ref[src];field=fingerprint'>[fields["fingerprint"]]</A><BR>\n\
			Physical Status: <A href='?src=\ref[src];field=p_stat'>[fields["p_stat"]]</A><BR>\n\
			Mental Status: <A href='?src=\ref[src];field=m_stat'>[fields["m_stat"]]</A><BR></td><td align = center valign = top>\
			Photo:<br><img src=front.png height=64 width=64 border=5><img src=side.png height=64 width=64 border=5></td></tr></table>"
	else
		dat += "<B>General Record Lost!</B><BR>"
	return dat
/datum/data/record/proc/print_med_bottom(var/obj/machinery/computer/med_data/M)
	var/dat
	...
	for(var/p_name in fields["prosthetics"])
		dat += text("<BR>\t [fields["prosthetics"][p_name]]")

	dat += text("<BR>\n<BR>\nImportant Notes:<BR>\n\t[]\
	<BR>\n<BR>\n<CENTER><B>Comments/Log</B></CENTER><BR>",
	M.decode(fields["notes"]))
	return dat
			...
			if (href_list["print_p"])
				if (!( src.printing ))
					...
					if (record2)
						...
						P.info += "<HR>\nProsthetics:"
						for(var/p_name in record2.fields["prosthetics"])
							P.info += text("\t<BR>\n[record2.fields["prosthetics"][p_name]]")
