...
/obj/machinery/vending/security
	...
	products = list(/obj/item/weapon/handcuffs = 8,/obj/item/weapon/grenade/flashbang = 4,/obj/item/device/assembly_holder/grenade/chem_grenade/teargas = 4,/obj/item/device/flash = 5,
