...
/obj/machinery/door/firedoor/attack_hand(mob/user)
	...
	if(needs_to_close)
		addtimer(new Callback(src, src::attempt_autoclose()), 10 SECONDS) //Just in case a fire alarm is turned off while the firedoor is going through an autoclose cycle
