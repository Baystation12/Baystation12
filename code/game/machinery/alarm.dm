...
/obj/machinery/alarm/update_icon()
	...
	set_light(l_range = 2, l_power = 1, l_color = new_color)
...
/obj/machinery/firealarm/update_icon()
	...
	if(stat & BROKEN)
		...
		if(!src.detecting)
			icon_state = "fire1"
			set_light(l_range = 2, l_power = 1, l_color = "#ff0000")
		else
			icon_state = "fire0"
			switch(seclevel)
				if("green")	set_light(l_range = 2, l_power = 1, l_color = "#00ff00")
				if("blue")	set_light(l_range = 2, l_power = 1, l_color = "#1024A9")
				if("red")	set_light(l_range = 4, l_power = 2, l_color = "#ff0000") //similar to small lightbulb
