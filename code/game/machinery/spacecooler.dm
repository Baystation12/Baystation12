...
/obj/machinery/space_heater/space_cooler
	anchored = 0
	density = 1
...
/obj/machinery/space_heater/space_cooler/update_icon()
	overlays.Cut()
...
/obj/machinery/space_heater/space_cooler/examine(mob/user)
	set src in oview(12)
	if (!( usr ))
		return
...
/obj/machinery/space_heater/space_cooler/emp_act(severity)
...
/obj/machinery/space_heater/space_cooler/attackby(obj/item/I, mob/user)
	if(istype(I, /obj/item/weapon/cell))
		...
		..()
	return
/obj/machinery/space_heater/space_cooler/attack_hand(mob/user as mob)
	src.add_fingerprint(user)
	interact(user)

/obj/machinery/space_heater/space_cooler/interact(mob/user as mob)
	if(open)
...
/obj/machinery/space_heater/space_cooler/Topic(href, href_list)
	if (usr.stat)
		return
...
/obj/machinery/space_heater/space_cooler/proc/chill()
...
/obj/machinery/space_heater/space_cooler/process()
	if(on)
