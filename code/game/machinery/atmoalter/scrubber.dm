...
/obj/machinery/portable_atmospherics/powered/scrubber/huge/use_tool(obj/item/I, mob/user)
	if(isWrench(I))
...
/obj/machinery/portable_atmospherics/powered/scrubber/huge/stationary/use_tool(obj/item/I, mob/user)
	if(isWrench(I))
