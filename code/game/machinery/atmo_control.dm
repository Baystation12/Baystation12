		...
		if(sensors.len)
			for(var/id_tag in sensors)
				...
				if(data)
					...
					sensor_part = "<FONT colour='red'>[long_name] can not be found!</FONT><BR>"
...
Rate: [volume_rate] L/sec<BR>"}
				...
				output += "<FONT colour='red'>ERROR: Can not find input port</FONT> <A href='?src=\ref[src];in_refresh_status=1'>Search</A><BR>"
...
Max Output Pressure: [output_pressure] kPa<BR>"}
				...
				output += "<FONT colour='red'>ERROR: Can not find output port</FONT> <A href='?src=\ref[src];out_refresh_status=1'>Search</A><BR>"
...
Rate: [volume_rate] L/sec<BR>"}
				...
				output += "<FONT colour='red'>ERROR: Can not find device</FONT> <A href='?src=\ref[src];refresh_status=1'>Search</A><BR>"
