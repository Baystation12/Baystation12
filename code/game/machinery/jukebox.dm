...
/obj/machinery/media/jukebox
	...
	var/list/datum/track/tracks = list(
		...
		new/datum/track("Birth of the Coalition", 'sound/music/Birth_of_the_Coalition.ogg'),
		...
		new/datum/track("Journey for her thoughts", 'sound/music/Journey_For_Her_Thoughts.ogg'),
		new/datum/track("June mermaid", 'sound/music/June_Mermaid.ogg'),
		new/datum/track("Human", 'sound/music/human.ogg'),
		new/datum/track("Kingdom's End", 'sound/music/Kingdoms_End.ogg'),
		...
		new/datum/track("Terminacoustica", 'sound/music/Terminacoustica.ogg'),
		new/datum/track("The girl forgotten by time", 'sound/music/The_Girl_Forgotten_By_Time.ogg'),
