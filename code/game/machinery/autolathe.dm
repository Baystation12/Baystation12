/obj/machinery/autolathe
	name = "autolathe"
	desc = "It produces items using metal, glass, plastic, and aluminum. It has a built in shredder that can recycle most items, although any materials it cannot use will be wasted."
