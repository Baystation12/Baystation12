...
/obj/machinery/lapvend/proc/scan_id(var/obj/item/weapon/card/id/C, var/obj/item/ID_container)
	if(C==ID_container || ID_container == null)
		visible_message("<span class='info'>\The [usr] swipes \the [C] through \the [src].</span>")
	else
...
/obj/machinery/lapvend/proc/reimburse_id(var/obj/item/weapon/card/id/C, var/obj/item/ID_container)
	if(C==ID_container || ID_container == null)
		visible_message("<span class='info'>\The [usr] swipes \the [C] through \the [src].</span>")
	else
		visible_message("<span class='info'>\The [usr] swipes \the [ID_container] through \the [src].</span>")
