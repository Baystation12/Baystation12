			...
			switch(href_list["operation"])
				...
				if("probe")
					if(machinelist.len > 0)
						...
						if(!machinelist.len)
							temp = "<font colour = #D70B00>- FAILED: UNABLE TO LOCATE NETWORK ENTITIES IN \[[network]\] -</font colour>"
						else
							temp = "<font colour = #336699>- [machinelist.len] ENTITIES LOCATED & BUFFERED -</font colour>"
