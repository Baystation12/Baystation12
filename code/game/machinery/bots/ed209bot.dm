...
/obj/machinery/bot/secbot/ed209/on_explosion(var/turf/Tsec)
	if(!lasercolor)
		...
		G.power_supply.charge = 0
	if (prob(50))
		new /obj/item/organ/external/l_leg/robot(Tsec)
		if (prob(25))
			new /obj/item/organ/external/r_leg/robot(Tsec)
...
/obj/item/weapon/secbot_assembly/ed209_assembly/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	switch(build_step)
		if(0,1)
			if(istype(W, /obj/item/organ/external/l_leg) || istype(W, /obj/item/organ/external/r_leg) )
