...
/obj/machinery/tele_projector/proc/clear_computer()
	if (!computer)
		return
	GLOB.destroyed_event.unregister(computer, src, /obj/machinery/tele_projector::lost_computer())
	computer = null
...
/obj/machinery/tele_projector/proc/set_computer(obj/machinery/computer/teleporter/_computer)
	...
	clear_computer()
	computer = _computer
	GLOB.destroyed_event.register(computer, src, /obj/machinery/tele_projector::lost_computer())
