...
/datum/antagonist/traitor/proc/give_codewords(mob/living/traitor_mob)
	...
	to_chat(traitor_mob, "<b>Code Phrase</b>: <span class='danger'>[SSjobs.syndicate_code_phrase]</span>")
	to_chat(traitor_mob, "<b>Code Response</b>: <span class='danger'>[SSjobs.syndicate_code_response]</span>")
	traitor_mob.StoreMemory("<b>Code Phrase</b>: [SSjobs.syndicate_code_phrase]", /decl/memory_options/system)
	traitor_mob.StoreMemory("<b>Code Response</b>: [SSjobs.syndicate_code_response]", /decl/memory_options/system)
