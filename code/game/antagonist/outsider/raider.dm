...
/obj/random/loot/raider/spawn_choices()
	return list(/obj/random/voidhelmet = 10,
...
/obj/item/paper/detergentpods
	...
	info = "What are you guys doing with those damn detergent pods, eating them?<BR>our washing machine is still broken and despite that we used 3 bags in last week!<BR><BR>and someone tell vox to cut use of lavender perfumes, it smells like if it escaped from detergent factory."
