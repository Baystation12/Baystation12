...
/obj/random/armory
	...
	item_to_spawn()
		return pick(prob(3);/obj/item/weapon/gun/projectile/shotgun/pump,\
					...
					prob(1);/obj/item/weapon/gun/projectile/automatic/carbine,\
					prob(2);/obj/item/weapon/gun/energy/laser/carbine,\
					prob(1);/obj/item/weapon/gun/energy/gun,\
					prob(3);/obj/item/weapon/gun/projectile/detective/semiauto/sec,\
					prob(2);/obj/item/weapon/gun/projectile/detective/semiauto/sec/wood,\
...
/obj/random/ammo
	...
	item_to_spawn()
		return pick(prob(3);/obj/item/weapon/storage/box/beanbags,\
					...
					prob(2);/obj/item/ammo_magazine/c45r,\
					prob(2);/obj/item/ammo_magazine/c45f,\
					prob(1);/obj/item/ammo_magazine/mc9mmt,\
					prob(3);/obj/item/ammo_magazine/mc9mmtr,\
