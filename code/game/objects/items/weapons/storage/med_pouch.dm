...
/obj/item/reagent_containers/hypospray/autoinjector/pouch_auto/ondansetron
	name = "emergency nausea autoinjector"
	starts_with = list(/datum/reagent/ondansetron = 5)
