/obj/item/weapon/stock_parts/circuitboard/shuttle_console
	name = T_BOARD("basic shuttle console")
	build_path = /obj/machinery/computer/shuttle_control
	origin_tech = list(TECH_DATA = 3)
	var/shuttle_tag

/obj/item/weapon/stock_parts/circuitboard/shuttle_console/construct(obj/machinery/computer/shuttle_control/M)
	M.shuttle_tag = shuttle_tag

/obj/item/weapon/stock_parts/circuitboard/shuttle_console/deconstruct(obj/machinery/computer/shuttle_control/M)
...
/obj/item/weapon/stock_parts/circuitboard/shuttle_console/explore/is_valid_shuttle(datum/shuttle/shuttle)
