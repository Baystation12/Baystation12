...
/obj/item/weapon/stock_parts/circuitboard/air_management/tank_control
...
* Construct *
************/
/obj/item/weapon/stock_parts/circuitboard/air_management/construct(var/obj/machinery/computer/general_air_control/C)
	if (..(C))
		if(console_name)
...
/obj/item/weapon/stock_parts/circuitboard/air_management/tank_control/construct(var/obj/machinery/computer/general_air_control/large_tank_control/LTC)
	if(..(LTC))
...
/obj/item/weapon/stock_parts/circuitboard/air_management/supermatter_core/construct(var/obj/machinery/computer/general_air_control/supermatter_core/SC)
	if(..(SC))
...
/obj/item/weapon/stock_parts/circuitboard/air_management/injector_control/construct(var/obj/machinery/computer/general_air_control/fuel_injection/FI)
	if(..(FI))
...
* Deconstruct *
**************/
/obj/item/weapon/stock_parts/circuitboard/air_management/deconstruct(var/obj/machinery/computer/general_air_control/C)
	if (..(C))
		console_name = C.name
...
/obj/item/weapon/stock_parts/circuitboard/air_management/tank_control/deconstruct(var/obj/machinery/computer/general_air_control/large_tank_control/LTC)
	if(..(LTC))
...
/obj/item/weapon/stock_parts/circuitboard/air_management/supermatter_core/deconstruct(var/obj/machinery/computer/general_air_control/supermatter_core/SC)
	if(..(SC))
...
/obj/item/weapon/stock_parts/circuitboard/air_management/injector_control/deconstruct(var/obj/machinery/computer/general_air_control/fuel_injection/FI)
	if(..(FI))
