...
/obj/item/weapon/circuitboard/air_management
	name = T_BOARD("atmosphere control console")
...
* Construct *
************/
/obj/item/weapon/circuitboard/air_management/construct(var/obj/machinery/computer/air_control/C)
	if (..(C))
		if(console_name)
...
/obj/item/weapon/circuitboard/air_management/injector_control/construct(var/obj/machinery/computer/air_control/fuel_injection/FI)
	if(..(FI))
...
* Deconstruct *
**************/
/obj/item/weapon/circuitboard/air_management/deconstruct(var/obj/machinery/computer/air_control/C)
	if (..(C))
		console_name = C.name
...
/obj/item/weapon/circuitboard/air_management/injector_control/deconstruct(var/obj/machinery/computer/air_control/fuel_injection/FI)
	if(..(FI))
