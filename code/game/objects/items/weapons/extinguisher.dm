...
/obj/item/weapon/extinguisher/examine(var/mob/user)
	if(..(user, 0))
		user << "\icon[src] [name] contains [reagents.volume] units of water left!"
	return
...
/obj/item/weapon/extinguisher/afterattack(var/atom/target, var/mob/user, var/flag)
	if(istype(target, /obj/item/weapon/storage) || istype(target, /obj/structure/table) || istype(target, /obj/structure/closet) || istype(target, /obj/item/weapon/reagent_containers) || istype(target, /obj/structure/sink))
		return
