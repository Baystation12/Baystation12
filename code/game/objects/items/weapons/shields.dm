...
/obj/item/shield/energy/attack_self(mob/living/user)
	...
	active = !active
	if (active)
		addtimer(new Callback(src, /obj/item/shield/energy::UpdateSoundLoop()), 0.25 SECONDS)
		playsound(src, 'sound/obj/item/shield/energy/shield-start.ogg', 40)
		force = 10
		w_class = ITEM_SIZE_NO_CONTAINER
	else
		addtimer(new Callback(src, /obj/item/shield/energy::UpdateSoundLoop()), 0.1 SECONDS)
