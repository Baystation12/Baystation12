...
/obj/item/flame/candle/use_tool(obj/item/W, mob/user)
...
/obj/item/flame/candle/use_on_atom(var/atom/A, mob/user)
	. = ..()
...
/obj/item/flame/candle/use_on_self(mob/user as mob)
	if(lit)
		lit = 0
		update_icon()
		set_light(0)
