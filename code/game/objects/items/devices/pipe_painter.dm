...
/obj/item/device/pipe_painter/afterattack(atom/A, mob/user as mob, proximity)
	...
	if(!istype(A,/obj/machinery/atmospherics/pipe) || istype(A,/obj/machinery/atmospherics/unary/tank) || istype(A,/obj/machinery/atmospherics/pipe/simple/heat_exchanging) || !in_range(user, A))
		return
