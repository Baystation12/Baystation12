...
/obj/item/device/flash/attack(mob/living/M as mob, mob/user as mob)
	...
	M.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has been flashed (attempt) with [src.name]  by [user.name] ([user.ckey])</font>")
	user.attack_log += text("\[[time_stamp()]\] <font colour='red'>Used the [src.name] to flash [M.name] ([M.ckey])</font>")
