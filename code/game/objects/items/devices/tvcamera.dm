/obj/item/device/tvcamera
	...
	desc = "A livestreaming press camera drone. It appears to be following the controller itself, and stabilizes at around head height. It does not appear to have any internal memory storage."
...
/obj/item/device/tvcamera/attack_self(mob/user)
	...
	var/datum/browser/popup = new(user, "Press Camera Drone", 300, 390, src)
