...
/obj/item/device/paint_sprayer/on_update_icon()
	...
	overlays += color_picker ? "paint_sprayer_red" : "paint_sprayer_blue"
	if (ismob(loc))
		var/mob/M = loc
...
/obj/item/device/paint_sprayer/afterattack(var/atom/A, var/mob/user, var/proximity, var/params)
	if (!proximity)
		return
...
/obj/item/device/paint_sprayer/proc/paint_floor(var/turf/simulated/floor/F, var/mob/user, var/params)
	if(!F.flooring)
...
/obj/item/device/paint_sprayer/proc/pick_color_from_floor(var/turf/simulated/floor/F, var/mob/user)
...
/obj/item/device/paint_sprayer/proc/paint_airlock(var/obj/machinery/door/airlock/D, var/mob/user)
	if (!D.paintable)
...
/obj/item/device/paint_sprayer/proc/pick_color_from_airlock(var/obj/machinery/door/airlock/D, var/mob/user)
	if (!D.paintable)
		return FALSE
...
/obj/item/device/paint_sprayer/proc/select_airlock_region(var/obj/machinery/door/airlock/D, var/mob/user, var/input_text)
	var/choice
...
/obj/item/device/paint_sprayer/proc/change_color(var/new_color, var/mob/user)
...
/obj/item/device/paint_sprayer/verb/toggle_mode()
