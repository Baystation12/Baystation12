/obj/item/device/aicard
	...
	attack(mob/living/silicon/ai/M as mob, mob/user as mob)
		...
		M.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has been carded with [src.name] by [user.name] ([user.ckey])</font>")
		user.attack_log += text("\[[time_stamp()]\] <font colour='red'>Used the [src.name] to card [M.name] ([M.ckey])</font>")
