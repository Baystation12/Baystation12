...
/datum/poster/bay_19
	...
	desc = "This ragged poster depicts a well dressed looking Unathi receiving a prestigious award. It appears to espouse greater co-operation and harmony between the two races. Curiously, the Unathi is adressed as a Soghun, the old and rather speciesist name humans used to give them."
