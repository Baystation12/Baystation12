...
/obj/structure/sign/use_item(obj/item/tool as obj, mob/user as mob)	//deconstruction
...
/obj/item/sign/use_item(obj/item/tool as obj, mob/user as mob)	//construction
