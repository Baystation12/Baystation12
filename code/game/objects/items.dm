...
/obj/item/proc/eyestab(mob/living/carbon/M as mob, mob/living/carbon/user as mob)
	...
	user.attack_log += "\[[time_stamp()]\]<font colour='red'> Attacked [M.name] ([M.ckey]) with [src.name] (INTENT: [uppertext(user.a_intent)])</font>"
	M.attack_log += "\[[time_stamp()]\]<font colour='orange'> Attacked by [user.name] ([user.ckey]) with [src.name] (INTENT: [uppertext(user.a_intent)])</font>"
...
/obj/item/add_blood(mob/living/carbon/human/M as mob)
	...
	if(!blood_DNA.len)
		blood_overlay.colour = blood_colour
