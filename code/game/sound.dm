...
/proc/playsound(atom/source, soundin, vol, vary, extrarange, falloff, is_global, frequency, is_ambiance = 0)
...
/mob/proc/playsound_local(turf/turf_source, soundin, vol, vary, frequency, falloff, is_global, extrarange)
