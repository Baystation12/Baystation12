...
/client/verb/staffwho()
	...
	if(config.admin_irc)
		to_chat(src, "<span class='info'>Adminhelps are also sent to Discord/IRC. If no admins are available in game try anyway and an admin on Discord or IRC may see it and respond.</span>")
