	...
	equip(var/mob/living/carbon/human/H)
		...
		switch(H.mind.role_alt_title)
			...
			if("Plasma Researcher")
				H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/scientist/plasmares(H), slot_w_uniform)
			if("Anomalist")
				H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/scientist/anomalist(H), slot_w_uniform)
			if("Xenoarcheologist")
				H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/scientist/xenoarch(H), slot_w_uniform)
...
/datum/job/xenobiologist
	...
	equip(var/mob/living/carbon/human/H)
		if(!H) return 0
		H.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_sci(H), slot_l_ear)
		H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/scientist/xenobio(H), slot_w_uniform)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/white(H), slot_shoes)
		H.equip_to_slot_or_del(new /obj/item/device/pda/science(H), slot_belt)
		switch(H.backbag)
			if(2) H.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/toxins(H), slot_back)
