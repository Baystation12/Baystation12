...
/datum/job/chaplain
	...
	equip(var/mob/living/carbon/human/H)
		...
		spawn(0)
			...
			var/new_religion = copytext(sanitize_russian(input(H, "You are the crew services officer. Would you like to change your religion? Default is Christianity, in SPACE.", "Name change", religion_name)),1,MAX_NAME_LEN)
		...
		spawn(1)
			...
			var/new_deity = copytext(sanitize_russian(input(H, "Would you like to change your deity? Default is Space Jesus.", "Name change", deity_name)),1,MAX_NAME_LEN)
