...
/datum/lang/main/obj/item/weapon
	...
	poster
		...
		var/cant_place = "You can't place this here!"
		var/stand_directly = "You must stand directly in front of the wall you wish to place that on."
		var/already_there = "There is already a poster there!"
		var/start_placing = "You start placing the poster on the wall..."
		var/place_poster = "You place the poster!"