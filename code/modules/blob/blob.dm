...
/obj/effect/blob/health_handler_config()
	return list(
		"max_health" = 30,
		"resist_brute" = 0.23,
		"resist_burn" = 1.25,
...
/obj/effect/blob/ex_act(var/severity)
	switch(severity)
		if(1)
			damage_health(rand(100, 120), DAMAGE_EXPLODE)
		if(2)
			damage_health(rand(60, 100), DAMAGE_EXPLODE)
		if(3)
			damage_health(rand(20, 60), DAMAGE_EXPLODE)
...
/obj/effect/blob/core/health_handler_config()
	. = ..()
	.["max_health"] = 450
...
/obj/effect/blob/core/secondary/health_handler_config()
	. = ..()
	.["max_health"] = 125
...
/obj/effect/blob/shield/health_handler_config()
	. = ..()
	.["max_health"] = 120
...
/obj/effect/blob/ravaging/health_handler_config()
	. = ..()
	.["max_health"] = 20
