...
/obj/item/weapon/book/manual/rust_engine/New()
	...
	dat = {"<html>
				...
				<li>Enable and max output on the left SMES in the engine room. This is to power the gyrotron.</li>
