...
/obj/item/device/assembly/infra/New()
	...
	beams = list()
	seen_turfs = list()
	proximity_trigger = new(src, /obj/item/device/assembly/infra::on_beam_entered(), /obj/item/device/assembly/infra::on_visibility_change(), world.view, PROXIMITY_EXCLUDE_HOLDER_TURF)
