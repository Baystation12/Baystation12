...
/obj/item/device/assembly/speaker/receive_data(var/list/data, var/obj/item/device/assembly/sender)
...
/obj/item/device/assembly/speaker/get_data(var/mob/user, var/ui_key)
	var/list/data = list()
	data.Add("Voice", voice, "Message", message, "Tone", active_tone, "Activate When Receiving Data", activate_on_received)
	return data

/obj/item/device/assembly/speaker/get_buttons(var/mob/user, var/ui_key)
	var/list/data = list()
	data.Add("Speak")
	return data

/obj/item/device/assembly/speaker/Topic(href, href_list)
	if(href_list["option"])
...
/obj/item/device/assembly/speaker/attackby(var/obj/O, var/mob/user)
