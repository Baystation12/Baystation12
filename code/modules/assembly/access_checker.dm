...
/obj/item/device/assembly/access_checker/get_help_info()
	var/T = "\
...
/obj/item/device/assembly/access_checker/receive_data(var/list/data)
...
/obj/item/device/assembly/access_checker/get_data()
	var/list/data = list()
	data.Add("Match Count Required", access_levels_required)
	return data

/obj/item/device/assembly/access_checker/get_nonset_data()
	var/list/data = list()
...
/obj/item/device/assembly/access_checker/get_buttons()
	var/list/data = list()
	data.Add("Set Access")
	return data

	//Got this from airlock_electronics..
/obj/item/device/assembly/access_checker/proc/access_window(var/mob/user as mob)
	var/t1 = ""
...
/obj/item/device/assembly/access_checker/Topic(href, href_list)
	if(href_list["close"])
