...
/obj/item/device/assembly/explosive/flash/igniter_act() // Can be activated via igniter or electricity.
	boom()

/obj/item/device/assembly/explosive/flash/activate()
	boom()
	return 1

/obj/item/device/assembly/explosive/flash/prime()
	activate()

	//Would make this a child of chem_grenade with flash powder, but probably less effective.
/obj/item/device/assembly/explosive/flash/boom()
...
/obj/item/device/assembly/explosive/flash/proc/bang(var/turf/T , var/mob/living/carbon/M)					// Added a new proc called 'bang' that takes a location and a person to be banged.
