/obj/item/device/assembly/explosive/strong
	...
	wire_safety(var/index = 0, var/pulsed = 0)
		if(!pulsed)
					...
					if(explosive_counting)
						...
						if(inp == "Yes" && explosive_counting)
							...
							if(prob(15))
								...
								usr.captured = 1 // Cheatey way to do it.
								usr << "<span class='danger'><small>You cut the wire and fall to your knees in horror as the timer is reduced to 10 seconds...</small></span>"
