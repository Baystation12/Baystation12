	...
	for (var/i in 1 to speed)
		...
		if(hasmob && prob(10))
			for(var/mob/living/H in check_mob(src))
				H.apply_damage(30, DAMAGE_BRUTE, null, DAM_DISPERSED, "Blunt Trauma", ARMOR_MELEE_MAJOR)//horribly maim any living creature jumping down disposals.  c'est la vie
