...
/obj/aiming_overlay/proc/aim_at(mob/target, obj/thing, no_target_change)
	...
	GLOB.moved_event.register(owner, src, /obj/aiming_overlay::update_aiming())
	GLOB.moved_event.register(aiming_at, src, /obj/aiming_overlay::target_moved())
	GLOB.destroyed_event.register(aiming_at, src, /obj/aiming_overlay::cancel_aiming())
