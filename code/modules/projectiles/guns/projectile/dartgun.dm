...
/obj/item/weapon/gun/projectile/dartgun
	name = "Z-H P Artemis"
	desc = "A dip of Zeng-Hu Pharmaceuticals into the arts of shooting each other. A gas-powered dart gun capable of delivering chemical cocktails swiftly across short distances. Favoured by assassins and slave traders."
