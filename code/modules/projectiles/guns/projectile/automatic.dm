...
/obj/item/weapon/gun/projectile/automatic/m516
	item_state = null
	w_class = ITEM_SIZE_HUGE
	force = 10
	caliber = "a556"
	origin_tech = list(TECH_COMBAT = 3, TECH_MATERIAL = 1, TECH_ILLEGAL = 3)
	slot_flags = SLOT_BACK
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/c556
	allowed_magazines = /obj/item/ammo_magazine/c556
	one_hand_penalty = 3
	name = "ancient assault rifle"
	desc = "The M516 is a durable automatic weapon of an ancient design. Uses 5.56mm rounds."
	icon_state = "mrifle"
	wielded_item_state = "mrifle-wielded"
...
/obj/item/weapon/gun/projectile/automatic/m516/update_icon()
	icon_state = (ammo_magazine)? "mrifle" : "mrifle-empty"
	wielded_item_state = (ammo_magazine)? "mrifle-wielded" : "mrifle-wielded-empty"
	..()
