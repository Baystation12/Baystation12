/obj/item/weapon/gun/projectile/automatic //Hopefully someone will find a way to make these fire in bursts or something. --Superxpdude
	...
	firemodes = list(
		...
		list(mode_name="short bursts",   burst=5, fire_delay=null, move_delay=4,    burst_accuracy=list(0,-1,-1,-1,-2), dispersion=list(0.6, 0.6, 1.0, 1.0, 1.2)),
		)
...
/obj/item/weapon/gun/projectile/automatic/sts35
	...
	firemodes = list(
		...
		list(mode_name="short bursts",   burst=5, fire_delay=null, move_delay=6,    burst_accuracy=list(0,-1,-2,-3,-3), dispersion=list(0.6, 1.0, 1.0, 1.2, 1.2)),
		)
