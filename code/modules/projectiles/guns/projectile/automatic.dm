...
/obj/item/weapon/gun/projectile/automatic/c20r
	...
	firemodes = list(
		...
		list(mode_name="short bursts",   burst=5, fire_delay=null, one_hand_penalty=4, burst_accuracy=list(0,-1,-1,-1,-2), dispersion=list(0.6, 0.6, 1.0, 1.0, 1.2)),
		)
...
/obj/item/weapon/gun/projectile/automatic/sts35
	...
	firemodes = list(
		list(mode_name="semiauto",       burst=1, fire_delay=0, one_hand_penalty=4, burst_accuracy=null, dispersion=null),
