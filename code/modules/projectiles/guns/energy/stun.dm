...
/obj/item/weapon/gun/energy/confuseray
	name = "disorientator"
	desc = "The W-T Mk. 4 Disorientator is a small, low capacity and short-ranged energy projector intended for personal defense with little risk of permanent damage or cross-fire."
