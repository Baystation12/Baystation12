/obj/item/weapon/gun/energy/temperature
	...
	attack_self(mob/living/user as mob)
		...
		if(temperature > (T0C - 50))
			temp_text = "<FONT colour=black>[temperature] ([round(temperature-T0C)]&deg;C) ([round(temperature*1.8-459.67)]&deg;F)</FONT>"
		else
			temp_text = "<FONT colour=blue>[temperature] ([round(temperature-T0C)]&deg;C) ([round(temperature*1.8-459.67)]&deg;F)</FONT>"
