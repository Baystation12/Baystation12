...
/obj/structure/particle_accelerator/use_item(obj/item/I, mob/user)
	if (I?.istool() && process_tool_hit(I, user))
		return TRUE
	return ..()
...
/obj/machinery/particle_accelerator/use_item(obj/item/I, mob/user)
	if (I?.istool() && process_tool_hit(I, user))
		return TRUE
	return ..()
