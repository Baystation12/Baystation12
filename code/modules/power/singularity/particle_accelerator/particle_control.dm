...
/obj/machinery/particle_accelerator/control_box/Topic(href, href_list)
	...
	if(href_list["togglep"])
		src.toggle_power()
		investigate_log("turned [active?"<font colour='red'>ON</font>":"<font colour='green'>OFF</font>"] by [usr.key]","singulo")
		if (active)
		...
		if(strength > 2)
			...
			investigate_log("increased to <font colour='red'>[strength]</font> by [usr.key]","singulo")
		for(var/obj/structure/particle_accelerator/part in connected_parts)
		...
		if(strength < 0)
			...
			investigate_log("decreased to <font colour='green'>[strength]</font> by [usr.key]","singulo")
		for(var/obj/structure/particle_accelerator/part in connected_parts)
			part.strength = strength
			part.update_icon()
	src.updateDialog()
...
/obj/machinery/particle_accelerator/control_box/process()
	if(src.active)
		...
		if( length(connected_parts) < 6 )
			investigate_log("lost a connected part; It <font colour='red'>powered down</font>.","singulo")
			src.toggle_power()
			return
		//emit some particles
