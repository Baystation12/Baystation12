...
/mob/living/simple_animal/hostile/retaliate/controlled_drone
	name = "automated combat drone"
	...
	var/has_loot = 1
	faction = "controlled_drone"

/mob/living/simple_animal/hostile/retaliate/controlled_drone/DestroySurroundings()
	if(prob(break_stuff_probability))
		for(var/dir in cardinal) // North, South, East, West
			...
			if(istype(obstacle, /obj/structure/window) || istype(obstacle, /obj/structure/closet) || istype(obstacle, /obj/structure/table) || istype(obstacle, /obj/structure/grille))
				obstacle.attack_generic(src,rand(melee_damage_lower,melee_damage_upper),attacktext)
				return
			var/turf/simulated/wall/W = locate(/obj/turf/simulated/wall, get_step(src, dir))
			Shoot(W, src.loc, src)

/mob/living/simple_animal/hostile/retaliate/controlled_drone/New(var/obj/item/projectile/beam/weapon)
	..()
...
/mob/living/simple_animal/hostile/retaliate/controlled_drone/Process_Spacemove(var/check_drift = 0)
	return 1

//self repair systems have a chance to bring the drone back to life
/mob/living/simple_animal/hostile/retaliate/controlled_drone/Life()
...
//ion rifle!
/mob/living/simple_animal/hostile/retaliate/controlled_drone/emp_act(severity)
	health -= rand(3,15) * (severity + 1)
	disabled = rand(150, 600)
	hostile_drone = 0
	walk(src,0)

/mob/living/simple_animal/hostile/retaliate/controlled_drone/death()
	..(null,"suddenly breaks apart.")
	qdel(src)

/mob/living/simple_animal/hostile/retaliate/controlled_drone/Destroy()
