...
/obj/effect/gateway/artifact/small/New(turf/T)
	...
	addtimer(new Callback(src, src::create_and_delete()), rand(15, 30) SECONDS)
...
/obj/effect/gateway/artifact/big/New(turf/T)
	...
	addtimer(new Callback(src, src::spawn_monster()), rand(30, 60) SECONDS)
...
/obj/effect/gateway/artifact/big/proc/spawn_monster()
	...
	addtimer(new Callback(src, src::spawn_monster()), rand(15, 30) SECONDS)
