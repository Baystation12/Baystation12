	...
	if(get_dist(src,user) <= 1)
		...
		if(access_level > 0)
			...
			if(creating_new_account)
				...
				dat += "<b>Holder name:</b> <input type='text' id='holder_name' name='holder_name' style='width:250px; background-colour:white;'><br>"
				dat += "<b>Initial funds:</b> <input type='text' id='starting_funds' name='starting_funds' style='width:250px; background-colour:white;'> (subtracted from station account)<br>"
