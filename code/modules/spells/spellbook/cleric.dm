...
/datum/spellbook/cleric
	...
	spell_desc = list("A quick recharging spell that heals a minor amount of damage.",
					...
					"This spell transforms the target into a harmless furry animal for a short duration.",
					"This spell shoots a bolt of energy that handcuffs and stuns a target. Can only be used 6 times.",
