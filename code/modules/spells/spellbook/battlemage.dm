...
/datum/spellbook/battlemage
	...
	spells = list(
		...
		/datum/spell/targeted/equip_item/dyrnwyn = 1,
		/datum/spell/targeted/equip_item/shield = 1,
		/datum/spell/targeted/projectile/dumbfire/fireball = 1,
		/datum/spell/targeted/torment = 1,
		/datum/spell/targeted/heal_target = 2,
		/datum/spell/targeted/genetic/mutate = 1,
		/datum/spell/aoe_turf/conjure/mirage = 1,
		/datum/spell/targeted/shapeshift/corrupt_form = 1,
