...
/spell/targeted/shapeshift/cast(list/targets, mob/user)
	for(var/m in targets)
		...
		GLOB.death_event.register(trans,src, /spell/targeted/shapeshift::stop_transformation())
		GLOB.destroyed_event.register(trans,src, /spell/targeted/shapeshift::stop_transformation())
		GLOB.destroyed_event.register(M, src, /spell/targeted/shapeshift::destroyed_transformer())
		if(duration)
			spawn(duration)
