...
/datum/species/alium/New()
	...
	brute_mod = round(total_health * Frand(0.5, 1.5), 0.1)
	burn_mod = round(total_health * Frand(0.8, 1.2), 0.1)
	oxy_mod = round(total_health * Frand(0.5, 1.5), 0.1)
	toxins_mod = round(total_health * Frand(0, 2), 0.1)
	radiation_mod = round(total_health * Frand(0, 2), 0.1)
	flash_mod = round(total_health * Frand(0.5, 1.5), 0.1)
