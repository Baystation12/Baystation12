/datum/species/nabber
	...
	assisted_langs = list(LANGUAGE_GUTTER, LANGUAGE_UNATHI_SINTA, LANGUAGE_SKRELLIAN, LANGUAGE_HUMAN_EURO, LANGUAGE_SIIK_MAAS, LANGUAGE_EAL, LANGUAGE_HUMAN_RUSSIAN)
	min_age = 8
	max_age = 40
