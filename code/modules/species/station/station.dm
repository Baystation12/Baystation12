/datum/species/human
	...
	inherent_verbs = list( /mob/living/carbon/human::tie_hair())
...
/proc/spawn_diona_nymph(turf/target)
	...
	addtimer(new Callback(nymph, /mob/living/carbon/alien/diona::check_spawn_death()), 30 SECONDS)
...
/datum/species/diona/handle_post_spawn(mob/living/carbon/human/H)
	H.gender = NEUTER
	. = ..()
	addtimer(new Callback(src, src::fill_with_nymphs(), H), 0)
