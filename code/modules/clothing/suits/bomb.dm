/obj/item/clothing/head/bomb_hood
	name = "bomb hood"
	desc = "A hood that protects from explosions. Also provides other protection."
	icon_state = "bombsuit"
...
/obj/item/clothing/suit/bomb_suit
	name = "bomb suit"
	desc = "A suit used for safely disposing of explosives. Also provides other protection."
	icon_state = "bombsuit"
	item_state = "bombsuit"
