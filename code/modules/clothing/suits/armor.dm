...
/obj/item/clothing/suit/storage/vest/charlie
	name = "United States Colonial Marines armored vest"
	desc = "An antiquated armor design, looks like something right out of an early human space exploration movie. It has a shoulder mounted flashlight."
