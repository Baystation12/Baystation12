...
//Maintenance RT//
/obj/item/clothing/suit/armor/maintenance/c_specialist
	name = "computer specialist's uniform"
	icon_state = "maitenance_computer_specialist"

/obj/item/clothing/suit/armor/maintenance/security
	name = "security grunt's uniform"
	icon_state = "maitenance_security_grunt"

/obj/item/clothing/suit/armor/maintenance/security/lead
	name = "security leader's uniform"
	icon_state = "maintenance_security_lead"

//Military RT//
/obj/item/clothing/suit/armor/soldier
	name = "grunt's RIG"
	desc = ""
	icon_state = "soldier_grunt_rig"

/obj/item/clothing/suit/armor/soldier/medic
	name = "medic's RIG"
	desc = ""
	icon_state = "soldier_medic_rig"

/obj/item/clothing/suit/armor/soldier/leader
	name = "soldier's RIG"
	desc = ""
	icon_state = "soldier_leader_rig"

/obj/item/clothing/suit/armor/soldier/engineer
	name = "engineer's RIG"
	desc = ""
	icon_state = "soldier_engineer_rig"

//Unitologist RT//
/obj/item/clothing/suit/armor/unitologist
	name = "faithful's RIG"
	desc = "An unknown style RIG suit."
	icon_state = "unitologist_faithful_rig"

/obj/item/clothing/suit/armor/unitologist/healer
	name = "healer's RIG"
	desc = "An unknown style RIG suit. This suit looks to be moderately protected and bears a lot of red on it, as if the suit was trying to drawn attention to itself."
	icon_state = "unitologist_healer_rig"

/obj/item/clothing/suit/armor/unitologist/mechanic
	name = "mechanic's RIG"
	desc = "An unknown style RIG suit."
	icon_state = "unitologist_mechanic_rig"

/obj/item/clothing/suit/armor/unitologist/berserker
	name = "berserker's RIG"
	desc = "An unknown style RIG suit. This heavy suit looks like it could take a severe beating."
	icon_state = "unitologist_berserker_rig"

/obj/item/clothing/suit/armor/unitologist/deacon
	name = "deacon's RIG"
	desc = "An unknown style RIG suit. Oddly enough, it looks like the suit is ceremonial, made more for ceremony than protection."
	icon_state = "unitologist_deacon_rig"