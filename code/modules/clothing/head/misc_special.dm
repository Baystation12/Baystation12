...
/obj/item/clothing/head/welding/use_on_self()
	if(!base_state)
...
/obj/item/clothing/head/cakehat/use_on_self(mob/user as mob)
...
/obj/item/clothing/head/ushanka/use_on_self(mob/user as mob)
