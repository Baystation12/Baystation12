...
/obj/item/clothing/head/helmet/space/rig
	...
	species_restricted = list("exclude","Unathi","Tajaran","Skrell","Diona","Vox","Tajaran (Black)","Tajaran (Orange)","Tajaran (Siamese)","Tajaran (Brown)","Tajaran (Blue)")
...
/obj/item/clothing/suit/space/rig
	...
	max_heat_protection_temperature = SPACE_SUIT_MAX_HEAT_PROTECTION_TEMPERATURE
	species_restricted = list("exclude","Unathi","Tajaran","Diona","Vox","Tajaran (Black)","Tajaran (Orange)","Tajaran (Siamese)","Tajaran (Brown)","Tajaran (Blue)")
