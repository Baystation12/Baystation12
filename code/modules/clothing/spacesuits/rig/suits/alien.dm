/obj/item/weapon/rig/unathi
	name = "cheap breacher chassis control module"
	desc = "A cheap knock-off of an Unathi battle-rig. Looks like a fish, moves like a fish, steers like a cow."
	suit_type = "breacher rig"
