...
/obj/item/rig_module/power_sink/proc/drain_complete(var/mob/living/M)
	...
	if(!interfaced_with)
		to_chat(if(M) M, "<font color='blue'><b>Total power drained:</b> [round(total_power_drained*CELLRATE)] Wh.</font>")

	else
		to_chat(if(M) M, "<font color='blue'><b>Total power drained from [interfaced_with]:</b> [round(total_power_drained*CELLRATE)] Wh.</font>")
