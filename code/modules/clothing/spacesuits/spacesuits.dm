...
/obj/item/clothing/head/helmet/space
	...
	species_restricted = list("exclude","Diona","Vox", "Xenomorph", "Xenomorph Drone", "Xenomorph Hunter", "Xenomorph Sentinel", "Xenomorph Queen","Wryn")
...
/obj/item/clothing/suit/space
	name = "Space suit"
	desc = "A suit that protects against low pressure environments. \"APOLLO STATION\" is written in large block letters on the back."
	icon_state = "space"
	item_state = "s_suit"
