...
/datun/craft_blueprint/cov_tool/adv_drill
...
/datun/craft_blueprint/cov_tool/sonic_jackhammer
...
/datun/craft_blueprint/cov_tool/diamond_drill
...
/datun/craft_blueprint/cov_tool/plasmacutter
	name = "plasma cutter"
...
/datun/craft_blueprint/cov_tool/plasma_drill
	name = "plasma drill"
	id = "cov_plasma_drill"
	materials = list("duridium" = 30, "osmium-carbide plasteel" = 15, "nanolaminate" = 10)
	build_path = /obj/item/weapon/pickaxe/plasma_drill
	components = list("covenant power cell" = /obj/item/weapon/cell/covenant, "plasma core" = /obj/item/plasma_core, "crystal matrix" = /datun/craft_blueprint/cov_component/crystalmatrix)
...
/datun/craft_blueprint/cov_tool/crowbar
	name = "crowbar"
	id = "cov_crowbar"
	materials = list(DEFAULT_WALL_MATERIAL = 10, "wood" = 10)
	build_path = /obj/item/weapon/crowbar/covenant

/datun/craft_blueprint/cov_tool/multitool
	name = "multitool"
	id = "cov_multitool"
...
/datun/craft_blueprint/cov_tool/surgicaldrill
	name = "surgical drill"
...
/datun/craft_blueprint/cov_tool/bonesetter
	name = "bone setter"
	id = "cov_bonesetter"
	materials = list(DEFAULT_WALL_MATERIAL = 10, "plasteel" = 5)
