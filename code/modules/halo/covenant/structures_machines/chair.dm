/obj/structure/bed/chair/covenant
	icon = 'code/modules/halo/covenant/structures_machines/chair.dmi'
...
/obj/structure/bed/chair/covenant/set_dir()
	..()
	overlays = null
	var/image/O = image(icon = 'code/modules/halo/covenant/structures_machines/chair.dmi', icon_state = "[base_icon]_over", dir = src.dir)
