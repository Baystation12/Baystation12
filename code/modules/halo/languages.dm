...
/datum/language/swedish
	...
	syllables = list(\
		...
		"den","der","det","era","ett","för",\
		"gen","han","ill","ing","int","jag",\
		"kan","lig","lla","lle","hår","mår",\
		"här","mär","med","men","nde","nge",\
...
/datum/language/norwegian
	...
	syllables = list(\
		...
		"ere","ett","før","gen","had","han",\
		"hen","ikk","ing","itt","jeg","kan",\
		"kke","ler","lig","lle","med","men",\
		"mme","nde","nge","nne","føs","ørn",\
...
/datum/language/finnish
	...
	syllables = list(\
		...
		"een","ell","ett","hän","ane",\
		"ine","inu","ise","isi","ist",\
		"itä","ksi","lis","lla","lle","lli",\
		"llä","min","nen","ole","oli","sen",\
		"sin","ssa","sta","sti","ten",\
		"tta","tää","vat","voi")
	ending_syllables = list(\
