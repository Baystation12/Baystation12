...
#define DEFENDER_MOBS_BY_FACTION list("UNSC"=list(/mob/living/simple_animal/hostile/defender_mob/unsc/marine, /mob/living/simple_animal/hostile/defender_mob/unsc/odst),"Covenant"=list(/mob/living/simple_animal/hostile/defender_mob/cov/grunt, /mob/living/simple_animal/hostile/defender_mob/cov/kig/mob/living/simple_animal),"Insurrection"=list(/hostile/defender_mob/innie/medium, /mob/living/simple_animal/hostile/defender_mob/innie/heavy))
