...
/datum/techprint/compression
	...
	ticks_max = 60
	design_unlocks = list(/datum/research_design/basic_matter_bin, /datum/research_design/plastique)
...
/datum/techprint/compression_two
	...
	ticks_max = 120
	design_unlocks = list(/datum/research_design/adv_matter_bin, /datum/research_design/implant_explosive)
...
/datum/techprint/compression_three
	...
	ticks_max = 300
	design_unlocks = list(/datum/research_design/super_matter_bin, /datum/research_design/implant_compressed)
