...
/obj/item/weapon/stock_parts/computer/scanner/paper/do_on_afterattack(mob/user, obj/item/weapon/paper/target, proximity)
...
/obj/item/weapon/stock_parts/computer/scanner/paper/do_on_attackby(mob/user, atom/target)
