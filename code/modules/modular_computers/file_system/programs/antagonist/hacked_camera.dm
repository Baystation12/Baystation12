...
/datum/nano_module/program/camera_monitor/hacked/can_access_network(mob/user, network_access)
	return TRUE

// The hacked variant has access to all commonly used networks.
/datum/nano_module/program/camera_monitor/hacked/modify_networks_list(list/networks)
