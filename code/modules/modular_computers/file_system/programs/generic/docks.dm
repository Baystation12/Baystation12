...
/datum/nano_module/program/docking/proc/refresh_docks()
	...
	for(var/obj/machinery/embedded_controller/radio/airlock/docking_port/D as anything in MACHINES_OF(/obj/machinery/embedded_controller/radio/airlock/docking_port))
		if(D.z in zlevels)
			var/shuttleside = 0
