/obj/item/weapon/reagent_containers/food/drinks/cans/cola
	description_fluff = "Space Cola is the most popular soft drink in known space. It was invented by Nikolas Fedorov, a Martian-Russian immigrant to Tau Ceti. He then went on to create Federov Beverages Inc., a soft drink corporation that is now part of Centauri Provisions."
...
/obj/item/weapon/reagent_containers/food/drinks/cans/dr_gibb
	description_fluff = "Originally made by a doctor seeking to mix several different flavors, this soda has become widely popular in the past decade. The drink has become so popular, in fact, that Federov Beverages bought it. Ever since then, the drink has never been the same. As a result, people all across known space beg for the old formula, but Federov Beverages does not appear to be listening."

/obj/item/weapon/reagent_containers/food/drinks/cans/starkist
	description_fluff = "Federov Beverages' attempt at an orange-flavored drink. Advertised as a nice summer beverage. The company tries to paint it as one of their more 'healthy' beverages due to its 'orange' and 'vitamins'."
...
/obj/item/weapon/reagent_containers/food/drinks/cans/lemon_lime
	description_fluff = "This is a NanoTrasen branded can of Lemon-Lime juice. NanoTrasen swears to their 'natural' beverage, but most people think differently. It was never as popular as their now discontinued Oh-Range brand."
