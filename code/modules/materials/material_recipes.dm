...
/material/steel/generate_recipes(var/reinforce_material)
	...
	. += new/datum/stack_recipe/light_small/red(src)
	. += new/datum/stack_recipe/light_small/emergency(src)
	. += new/datum/stack_recipe/light_spot(src)
	. += new/datum/stack_recipe/light_nav(src)
...
/material/plastic/generate_recipes(var/reinforce_material)
	...
	. += new/datum/stack_recipe/newscaster(src)
	. += new/datum/stack_recipe/newscaster/sec(src)
	. += new/datum/stack_recipe/status_display(src)
	. += new/datum/stack_recipe/status_display/supply(src)
	. += new/datum/stack_recipe/status_display/ai(src)
