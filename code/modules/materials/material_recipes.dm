...
/material/proc/generate_recipes()
	...
	recipes += new/datum/stack_recipe("[display_name] baseball bat", /obj/item/weapon/material/twohanded/baseballbat, 10, time = 20, one_per_turf = 0, on_floor = 1, supplied_material = "[name]", goes_in_hands = 1)
	recipes += new/datum/stack_recipe("[display_name] ashtray", /obj/item/weapon/material/ashtray, 2, one_per_turf = 1, on_floor = 1, supplied_material = "[name]", goes_in_hands = 1)
	recipes += new/datum/stack_recipe("[display_name] spoon", /obj/item/weapon/material/kitchen/utensil/spoon/plastic, 1, on_floor = 1, supplied_material = "[name]", goes_in_hands = 1)
	...
	if(hardness>50)
		recipes += new/datum/stack_recipe("[display_name] fork", /obj/item/weapon/material/kitchen/utensil/fork/plastic, 1, on_floor = 1, supplied_material = "[name]", goes_in_hands = 1)
		recipes += new/datum/stack_recipe("[display_name] knife", /obj/item/weapon/material/kitchen/utensil/knife/plastic, 1, on_floor = 1, supplied_material = "[name]", goes_in_hands = 1)
		recipes += new/datum/stack_recipe("[display_name] blade", /obj/item/weapon/material/butterflyblade, 6, time = 20, one_per_turf = 0, on_floor = 1, supplied_material = "[name]", goes_in_hands = 1)
...
/material/steel/generate_recipes()
	...
	recipes += new/datum/stack_recipe("key", /obj/item/weapon/key, 1, time = 10, one_per_turf = 0, on_floor = 1, goes_in_hands = 1)
	...
	recipes += new/datum/stack_recipe("regular floor tile", /obj/item/stack/tile/floor, 1, 4, 20, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("metal rod", /obj/item/stack/rods, 1, 2, 60, goes_in_hands = 1)
	...
	recipes += new/datum/stack_recipe("grenade casing", /obj/item/weapon/grenade/chem_grenade, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("light fixture frame", /obj/item/frame/light, 2, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("small light fixture frame", /obj/item/frame/light/small, 1, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("apc frame", /obj/item/frame/apc, 2, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("air alarm frame", /obj/item/frame/air_alarm, 2, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("fire alarm frame", /obj/item/frame/fire_alarm, 2, goes_in_hands = 1)
...
/material/plasteel/generate_recipes()
	...
	recipes += new/datum/stack_recipe("knife grip", /obj/item/weapon/material/butterflyhandle, 4, time = 20, one_per_turf = 0, on_floor = 1, supplied_material = "[name]", goes_in_hands = 1)
...
/material/plastic/generate_recipes()
	...
	recipes += new/datum/stack_recipe("blood pack", /obj/item/weapon/reagent_containers/blood/empty, 4, on_floor = 0, goes_in_hands = 1)
...
/material/wood/generate_recipes()
	..()
	recipes += new/datum/stack_recipe("wooden sandals", /obj/item/clothing/shoes/sandal, 1, goes_in_hands = 1)
	...
	recipes += new/datum/stack_recipe("crossbow frame", /obj/item/weapon/crossbowframe, 5, time = 25, one_per_turf = 0, on_floor = 0, goes_in_hands = 1)
	...
	recipes += new/datum/stack_recipe("zip gun frame", /obj/item/weapon/zipgunframe, 5, goes_in_hands = 1)

/material/cardboard/generate_recipes()
	..()
	recipes += new/datum/stack_recipe("box", /obj/item/weapon/storage/box, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("large box", /obj/item/weapon/storage/box/large, 2)
	recipes += new/datum/stack_recipe("donut box", /obj/item/weapon/storage/box/donut/empty, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("egg box", /obj/item/weapon/storage/fancy/egg_box, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("light tubes box", /obj/item/weapon/storage/box/lights/tubes, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("light bulbs box", /obj/item/weapon/storage/box/lights/bulbs, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("mouse traps box", /obj/item/weapon/storage/box/mousetraps, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("cardborg suit", /obj/item/clothing/suit/cardborg, 3)
	recipes += new/datum/stack_recipe("cardborg helmet", /obj/item/clothing/head/cardborg, goes_in_hands = 1)
	recipes += new/datum/stack_recipe("pizza box", /obj/item/pizzabox, goes_in_hands = 1)
	recipes += new/datum/stack_recipe_list("folders",list( \
		new/datum/stack_recipe("blue folder", /obj/item/weapon/folder/blue, goes_in_hands = 1), \
		new/datum/stack_recipe("grey folder", /obj/item/weapon/folder, goes_in_hands = 1), \
		new/datum/stack_recipe("red folder", /obj/item/weapon/folder/red, goes_in_hands = 1), \
		new/datum/stack_recipe("white folder", /obj/item/weapon/folder/white, goes_in_hands = 1), \
		new/datum/stack_recipe("yellow folder", /obj/item/weapon/folder/yellow, goes_in_hands = 1), \
		))
