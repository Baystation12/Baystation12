...
/obj/screen/exosuit/hardpoint/proc/update_system_info()
	...
	maptext =  SPAN_WITH_STYLE("font-family: 'Small Fonts'; -dm-text-outline: 1 black; font-size: 7px;", "[holding.get_hardpoint_maptext()]")
	...
	if(ui_damage)
		value = -1
		maptext = SPAN_WITH_STYLE("font-family: 'Small Fonts'; -dm-text-outline: 1 black; font-size: 7px;", "ERROR")
	else
