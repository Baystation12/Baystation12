...
/obj/machinery/atmospherics/unary/vent_scrubber/proc/broadcast_status()
	...
	signal.data = list(
		...
		"filter_phoron" = (MATERIAL_PHORON in scrubbing_gas),
...
/obj/machinery/atmospherics/unary/vent_scrubber/receive_signal(datum/signal/signal)
	...
	if(!isnull(signal.data["tox_scrub"]) && text2num(signal.data["tox_scrub"]) != (MATERIAL_PHORON in scrubbing_gas))
		toggle += MATERIAL_PHORON
