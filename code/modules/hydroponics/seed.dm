...
/datum/seed/proc/get_icon(growth_stage)
	...
	switch(get_growth_type())
		if(1)
			res.icon_state = "worms"
		if(2)
			res.icon_state = "vines-[growth_stage]"
		if(3)
			res.icon_state = "mass-[growth_stage]"
		if(4)
			res.icon_state = "mold-[growth_stage]"
		else
