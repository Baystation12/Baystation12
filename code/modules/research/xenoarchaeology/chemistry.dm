...
datum
	reagent
		tungsten
			...
			reagent_state = SOLID
			colour = "#DCDCDC"  // rgb: 220, 220, 220, silver
		...
		lithiumsodiumtungstate
			...
			colour = "#C0C0C0"  // rgb: 192, 192, 192, darker silver
		...
		ground_rock
			...
			reagent_state = SOLID
			colour = "#A0522D"   //rgb: 160, 82, 45, brown
		...
		density_separated_sample
			...
			reagent_state = LIQUID
			colour = "#DEB887"   //rgb: 222, 184, 135, light brown
		...
		analysis_sample
			...
			reagent_state = LIQUID
			colour = "#F5FFFA"   //rgb: 245, 255, 250, almost white
		...
		chemical_waste
			...
			reagent_state = LIQUID
			colour = "#ADFF2F"   //rgb: 173, 255, 47, toxic green
