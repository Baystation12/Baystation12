...
//This proc is used in subtypes for assigning names and descriptions dynamically
...
datum/design/circuit/AssembleDesignInfo()
	desc = "Allows for the construction of circuit boards used to build \a [name]."
