...
/datum/design/item/disk/design
	...
	materials = list("steel" = 30, "glass" = 10)
...
/datum/design/item/stock_part/basic_capacitor
	...
	materials = list("steel" = 50, "glass" = 50)
...
/datum/design/item/stock_part/super_capacitor
	...
	materials = list("steel" = 50, "glass" = 50, "gold" = 20)
...
/datum/design/item/stock_part/basic_micro_laser
	...
	materials = list("steel" = 10, "glass" = 20)
...
/datum/design/item/stock_part/ultra_micro_laser
	...
	materials = list("steel" = 10, "glass" = 20, "uranium" = 10)
...
/datum/design/item/stock_part/basic_sensor
	id = "basic_sensor"
	req_tech = list(TECH_MAGNET = 1)
	materials = list("steel" = 50, "glass" = 20)
...
/datum/design/item/stock_part/phasic_sensor
	...
	materials = list("steel" = 50, "glass" = 20, "silver" = 10)
...
/datum/design/item/stock_part/RPED
	...
	materials = list("steel" = 15000, "glass" = 5000)
...
/datum/design/item/powercell/basic
	...
	id = "basic_cell"
	req_tech = list(TECH_POWER = 1)
	materials = list("steel" = 700, "glass" = 50)
...
/datum/design/item/powercell/high
	...
	materials = list("steel" = 700, "glass" = 60)
...
/datum/design/item/powercell/super
	...
	materials = list("steel" = 700, "glass" = 70)
...
/datum/design/item/powercell/hyper
	...
	id = "hyper_cell"
	req_tech = list(TECH_POWER = 5, TECH_MATERIAL = 4)
	materials = list("steel" = 400, "gold" = 150, "silver" = 150, "glass" = 70)
...
/datum/design/item/powercell/device/standard
	...
	req_tech = list(TECH_POWER = 1)
	materials = list("steel" = 70, "glass" = 5)
...
/datum/design/item/powercell/device/high
	...
	id = "device_cell_high"
	req_tech = list(TECH_POWER = 2)
	materials = list("steel" = 70, "glass" = 6)
...
/datum/design/item/optical/tactical
	...
	materials = list("steel" = 50, "glass" = 50, "silver" = 50, "gold" = 50)
...
/datum/design/item/mining/jackhammer
	...
	materials = list("steel" = 2000, "glass" = 500, "silver" = 500)
...
/datum/design/item/mining/drill
	...
	materials = list("steel" = 6000, "glass" = 1000) //expensive, but no need for miners.
...
/datum/design/item/mining/plasmacutter
	...
	materials = list("steel" = 1500, "glass" = 500, "gold" = 500, "phoron" = 500)
...
/datum/design/item/mining/drill_diamond
	...
	materials = list("steel" = 3000, "glass" = 1000, "diamond" = 2000)
...
/datum/design/item/mining/depth_scanner
	...
	materials = list("steel" = 1000,"glass" = 1000)
	build_path = /obj/item/device/depth_scanner
	sort_string = "KAAAF"

/datum/design/item/medical
	materials = list("steel" = 30, "glass" = 20)
...
/datum/design/item/medical/slime_scanner
	...
	materials = list("steel" = 200, "glass" = 100)
...
/datum/design/item/medical/robot_scanner
	...
	materials = list("steel" = 500, "glass" = 200)
...
/datum/design/item/medical/nanopaste
	...
	materials = list("steel" = 7000, "glass" = 7000)
...
/datum/design/item/medical/hypospray
	...
	materials = list("steel" = 8000, "glass" = 8000, "silver" = 2000)
...
/datum/design/item/surgery/scalpel_laser1
	...
	materials = list("steel" = 12500, "glass" = 7500)
...
/datum/design/item/surgery/scalpel_laser2
	...
	materials = list("steel" = 12500, "glass" = 7500, "silver" = 2500)
...
/datum/design/item/surgery/scalpel_laser3
	...
	materials = list("steel" = 12500, "glass" = 7500, "silver" = 2000, "gold" = 1500)
...
/datum/design/item/surgery/scalpel_manager
	...
	materials = list ("steel" = 12500, "glass" = 7500, "silver" = 1500, "gold" = 1500, "diamond" = 750)
...
/datum/design/item/beaker/bluespace
	...
	materials = list("steel" = 3000, "phoron" = 3000, "diamond" = 500)
...
/datum/design/item/weapon/chemsprayer
	...
	materials = list("steel" = 5000, "glass" = 1000)
...
/datum/design/item/weapon/temp_gun
	...
	materials = list("steel" = 5000, "glass" = 500, "silver" = 3000)
...
/datum/design/item/weapon/anti_photon
	...
	materials = list("steel" = 3000, "glass" = 1000, "diamond" = 1000)
...
/datum/design/item/weapon/flora_gun
	...
	materials = list("steel" = 2000, "glass" = 500, "uranium" = 500)
...
/datum/design/item/weapon/advancedflash
	...
	materials = list("steel" = 2000, "glass" = 2000, "silver" = 500)
...
/datum/design/item/weapon/stunrifle
	...
	materials = list("steel" = 4000, "glass" = 1000, "silver" = 500)
...
/datum/design/item/weapon/nuclear_gun
	...
	materials = list("steel" = 5000, "glass" = 1000, "uranium" = 500)
...
/datum/design/item/weapon/lasercannon
	...
	id = "lasercannon"
	req_tech = list(TECH_COMBAT = 4, TECH_MATERIAL = 3, TECH_POWER = 3)
	materials = list("steel" = 10000, "glass" = 1000, "diamond" = 2000)
...
/datum/design/item/weapon/xraypistol
	...
	materials = list("steel" = 4000, "glass" = 500, "uranium" = 500)
...
/datum/design/item/weapon/xrayrifle
	...
	materials = list("steel" = 5000, "glass" = 1000, "uranium" = 1000)
...
/datum/design/item/weapon/flechette
	...
	materials = list("steel" = 8000, "gold" = 4000, "silver" = 4000, "diamond" = 2000)
...
/datum/design/item/weapon/phoronpistol
	...
	materials = list("steel" = 5000, "glass" = 1000, "phoron" = 3000)
...
/datum/design/item/weapon/smg
	...
	materials = list("steel" = 8000, "silver" = 2000, "diamond" = 1000)
...
/datum/design/item/weapon/wt550
	...
	materials = list("steel" = 8000, "silver" = 3000, "diamond" = 1500)
...
/datum/design/item/weapon/bullpup
	...
	materials = list("steel" = 10000, "silver" = 5000, "diamond" = 3000)
...
/datum/design/item/weapon/ammunition/ammo_9mm
	id = "ammo_9mm"
	req_tech = list(TECH_COMBAT = 4, TECH_MATERIAL = 3)
	materials = list("steel" = 3750, "silver" = 100)
...
/datum/design/item/weapon/ammunition/ammo_emp_38
	...
	materials = list("steel" = 2500, "uranium" = 750)
	req_tech = list(TECH_COMBAT = 3, TECH_MATERIAL = 3)
...
/datum/design/item/weapon/ammunition/ammo_emp_slug
	...
	materials = list("steel" = 3000, "uranium" = 1000)
	req_tech = list(TECH_COMBAT = 4, TECH_MATERIAL = 3)
...
/datum/design/item/stock_part/subspace_ansible
	...
	materials = list("steel" = 80, "silver" = 20)
...
/datum/design/item/stock_part/hyperwave_filter
	...
	materials = list("steel" = 40, "silver" = 10)
...
/datum/design/item/stock_part/subspace_amplifier
	id = "s-amplifier"
	req_tech = list(TECH_DATA = 3, TECH_MAGNET = 4, TECH_MATERIAL = 4, TECH_BLUESPACE = 2)
	materials = list("steel" = 10, "gold" = 30, "uranium" = 15)
...
/datum/design/item/stock_part/subspace_treatment
	...
	materials = list("steel" = 10, "silver" = 20)
...
/datum/design/item/stock_part/subspace_analyzer
	id = "s-analyzer"
	req_tech = list(TECH_DATA = 3, TECH_MAGNET = 4, TECH_MATERIAL = 4, TECH_BLUESPACE = 2)
	materials = list("steel" = 10, "gold" = 15)
...
/datum/design/item/synthstorage/paicard
	...
	materials = list("glass" = 500, "steel" = 500)
...
/datum/design/item/synthstorage/posibrain
	...
	build_type = PROTOLATHE | MECHFAB
	materials = list("steel" = 2000, "glass" = 1000, "silver" = 1000, "gold" = 500, "phoron" = 500, "diamond" = 100)
...
/datum/design/item/biostorage/neural_lace
	...
	materials = list ("steel" = 10000, "glass" = 7500, "silver" = 1000, "gold" = 1000)
...
/datum/design/item/biostorage/mmi
	...
	build_type = PROTOLATHE | MECHFAB
	materials = list("steel" = 1000, "glass" = 500)
...
/datum/design/item/biostorage/mmi_radio
	...
	build_type = PROTOLATHE | MECHFAB
	materials = list("steel" = 1200, "glass" = 500)
...
/datum/design/item/bluespace/beacon
	...
	materials = list ("steel" = 20, "glass" = 10)
...
/datum/design/item/bluespace/ano_scanner
	...
	materials = list("steel" = 10000,"glass" = 5000)
...
/datum/design/item/tool/light_replacer
	...
	materials = list("steel" = 1500, "silver" = 150, "glass" = 3000)
...
/datum/design/item/tool/airlock_brace
	...
	materials = list("steel" = 2000, "glass" = 50)
...
/datum/design/item/tool/clamp
	...
	materials = list("steel" = 500, "glass" = 500)
...
/datum/design/item/tool/inducer
	...
	materials = list("steel" = 2000, "glass" = 100)
...
/datum/design/item/tool/price_scanner
	...
	materials = list("steel" = 3000, "glass" = 3000, "silver" = 250)
...
/datum/design/item/tool/experimental_welder
	...
	materials = list("steel" = 120, "glass" = 50)
...
/datum/design/item/tool/shield_diffuser
	...
	materials = list("steel" = 5000, "glass" = 5000, "gold" = 2000, "silver" = 2000)
...
/datum/design/item/encryptionkey/binary
	...
	materials = list("steel" = 300, "glass" = 300)
...
/datum/design/item/smes_coil
	...
	materials = list("steel" = 2000, "glass" = 2000, "gold" = 1000, "silver" = 1000)
...
/datum/design/item/modularcomponent/disk/normal
	...
	build_type = PROTOLATHE
	materials = list("steel" = 400, "glass" = 100)
...
/datum/design/item/modularcomponent/disk/advanced
	...
	build_type = PROTOLATHE
	materials = list("steel" = 800, "glass" = 200)
...
/datum/design/item/modularcomponent/disk/super
	...
	build_type = PROTOLATHE
	materials = list("steel" = 1600, "glass" = 400)
...
/datum/design/item/modularcomponent/disk/cluster
	...
	build_type = PROTOLATHE
	materials = list("steel" = 3200, "glass" = 800)
...
/datum/design/item/modularcomponent/netcard/basic
	...
	materials = list("steel" = 250, "glass" = 100)
...
/datum/design/item/modularcomponent/netcard/wired
	...
	build_type = IMPRINTER
	materials = list("steel" = 2500, "glass" = 400)
	chemicals = list(/datum/reagent/acid = 20)
...
/datum/design/item/modularcomponent/accessory/reagent_scanner
	...
	build_type = PROTOLATHE
	materials = list("steel" = 600, "glass" = 200)
...
/datum/design/item/modularcomponent/cpu/photonic
	...
	build_type = IMPRINTER
	materials = list("steel" = 6400, glass = 2000)
...
/datum/design/item/modularcomponent/cpu/photonic/small
	...
	build_type = IMPRINTER
	materials = list("steel" = 3200, glass = 1000)
	chemicals = list(/datum/reagent/acid = 20)
...
/datum/design/item/rig/meson
	...
	materials = list("steel" = 100, "glass" = 200, "plastic" = 300)
...
/datum/design/item/rig/nvg
	...
	materials = list("plastic" = 500, "steel" = 300, "glass" = 200, "uranium" = 200)
...
/datum/design/item/rig/healthscanner
	...
	materials = list("plastic" = 1000, "steel" = 700, "glass" = 500)
...
/datum/design/item/rig/drill
	...
	materials = list("steel" = 3500, "glass" = 1500, "diamond" = 2000, "plastic" = 1000)
...
/datum/design/item/rig/plasmacutter
	...
	materials = list("steel" = 2000, "glass" = 1000, "plastic" = 1000, "gold" = 700, "phoron" = 500)
...
/datum/design/item/rig/orescanner
	...
	materials = list("plastic" = 1000, "steel" = 800, "glass" = 500)
...
/datum/design/item/rig/rcd
	...
	materials = list("steel" = 2000, "glass" = 1000, "plastic" = 1000,"gold" = 700, "silver" = 700)
...
/datum/design/item/rig/jets
	...
	materials = list("steel" = 3000, "plastic" = 2000, "glass" = 1000)
...
/datum/design/item/rig/powersink
	...
	materials = list("steel" = 2000, "glass" = 2000, "gold" = 1000, "plastic" = 1000)
...
/datum/design/item/rig/ai_container
	...
	materials = list("steel" = 1000, "glass" = 1000, "plastic" = 1000, "gold" = 500)
...
/datum/design/item/rig/flash
	...
	materials = list("plastic" = 1500, "steel" = 1000, "glass" = 500)
...
/datum/design/item/rig/taser
	...
	materials = list("steel" = 4000, "plastic" = 2500, "glass" = 2000, "gold" = 1000)
...
/datum/design/item/rig/egun
	...
	materials = list("steel" = 6000, "glass" = 3000, "plastic" = 2500, "gold" = 2000, "silver" = 1000)
...
/datum/design/item/rig/enet
	...
	materials = list("steel" = 6000, "glass" = 3000, "diamond" = 2000, "plastic" = 2000)
...
/datum/design/item/rig/stealth
	...
	materials = list("steel" = 6000, "glass" = 3000, "diamond" = 2000, "silver" = 2000, "uranium" = 2000, "gold" = 2000, "plastic" = 2000)
...
/datum/design/item/rig/cooling_unit
	...
	materials = list("steel" = 3000, "glass" = 3500, "plastic" = 2000)
...
/datum/design/item/integrated_printer_upgrade_advanced
	...
	materials = list("steel" = 10000, "glass" = 10000)
...
/datum/design/item/party
	...
	build_type = MECHFAB
	materials = list("steel" = 10000, "diamond" = 2000)
