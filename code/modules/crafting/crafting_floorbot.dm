/singleton/crafting_stage/empty_storage/floorbot
	...
	next_stages = list(/singleton/crafting_stage/proximity/floorbot)

/singleton/crafting_stage/proximity/floorbot
	progress_message = "You wedge the proximity sensor in amongst the floor tiles."
	item_icon_state = "floorbot_2"
	next_stages = list(/singleton/crafting_stage/robot_arms/floorbot)

/singleton/crafting_stage/robot_arms/floorbot
	progress_message = "You add the arms to the assembly to create a floorbot. Beep boop."
	product = /mob/living/bot/floorbot

/singleton/crafting_stage/robot_arms/floorbot/get_product(obj/item/work)
	. = ..()
