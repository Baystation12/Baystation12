...
/singleton/crafting_stage/material/coilgun_body
	...
	next_stages = list(/singleton/crafting_stage/tape/coilgun)

/singleton/crafting_stage/tape/coilgun
	...
	next_stages = list(/singleton/crafting_stage/pipe/coilgun)

/singleton/crafting_stage/pipe/coilgun
	...
	next_stages = list(/singleton/crafting_stage/welding/coilgun)

/singleton/crafting_stage/welding/coilgun
	...
	next_stages = list(/singleton/crafting_stage/wiring/coilgun)

/singleton/crafting_stage/wiring/coilgun
	...
	next_stages = list(/singleton/crafting_stage/coilgun_coil)

/singleton/crafting_stage/coilgun_coil
	...
	next_stages = list(/singleton/crafting_stage/coilgun_coil/two)

/singleton/crafting_stage/coilgun_coil/two
	...
	next_stages = list(/singleton/crafting_stage/coilgun_rail)

/singleton/crafting_stage/coilgun_rail
	...
	next_stages = list(/singleton/crafting_stage/screwdriver/coilgun)

/singleton/crafting_stage/screwdriver/coilgun
...
/singleton/crafting_stage/pipe/zipgun
	begins_with_object_type = /obj/item/weapon_frame
	...
	next_stages = list(/singleton/crafting_stage/tape/zipgun)

/singleton/crafting_stage/tape/zipgun
...
/singleton/crafting_stage/zipgun_trigger
	...
	next_stages = list(/singleton/crafting_stage/screwdriver/zipgun)
...
/singleton/crafting_stage/crossbow_switch
	begins_with_object_type = /obj/item/weapon_frame
	completion_trigger_type = /obj/item/frame/light_switch
	item_icon_state = "crossbow1"
	progress_message = "You disassemble the switch and amount it under the stock."
	next_stages = list(/singleton/crafting_stage/crossbow_rods)

/singleton/crafting_stage/crossbow_rods
	...
	next_stages = list(/singleton/crafting_stage/welding/crossbow_rods)

/singleton/crafting_stage/welding/crossbow_rods
	...
	next_stages = list(/singleton/crafting_stage/wiring/crossbow_battery)

/singleton/crafting_stage/wiring/crossbow_battery
	...
	next_stages = list(/singleton/crafting_stage/material/crossbow_plastic)

/singleton/crafting_stage/material/crossbow_plastic
	...
	next_stages = list(/singleton/crafting_stage/wiring/crossbow_string)

/singleton/crafting_stage/wiring/crossbow_string
	...
	next_stages = list(/singleton/crafting_stage/screwdriver/crossbow)

/singleton/crafting_stage/screwdriver/crossbow
