...
/singleton/crafting_stage/balisong_blade
	...
	next_stages = list(/singleton/crafting_stage/screwdriver/balisong)

/singleton/crafting_stage/screwdriver/balisong
	progress_message = "You secure the handle and the blade together."
	product = /obj/item/material/knife/folding/combat/balisong

/singleton/crafting_stage/screwdriver/balisong/get_product(obj/item/work)
...
/singleton/crafting_stage/sword_wires
	...
	next_stages = list(/singleton/crafting_stage/material/sword_handle)

/singleton/crafting_stage/material/sword_handle
...
/singleton/crafting_stage/material/armor_half
	...
	next_stages = list(/singleton/crafting_stage/armor_full)

/singleton/crafting_stage/armor_full
