...
/singleton/crafting_stage/farmbot_begin
	...
	next_stages = list(/singleton/crafting_stage/farmbot_bucket)
	item_icon_state = "farmbot_1"

/singleton/crafting_stage/farmbot_bucket
	progress_message = "You attach the bucket to the assembly."
	completion_trigger_type = /obj/item/reagent_containers/glass/bucket
	next_stages = list(/singleton/crafting_stage/farmbot_minihoe)
	item_icon_state = "farmbot_1"

/singleton/crafting_stage/farmbot_minihoe
	progress_message = "You attach the minihoe to the assembly."
	completion_trigger_type = /obj/item/material/minihoe
	next_stages = list(/singleton/crafting_stage/proximity/farmbot)
	item_icon_state = "farmbot_1"

/singleton/crafting_stage/proximity/farmbot
