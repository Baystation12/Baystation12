...
/datum/event/exo_awakening/start()
	...
	addtimer(new Callback(src, /datum/event/exo_awakening::start_spawning()), delay_time)
	...
	while (I < n)
		...
		if (prob(spawn_chance))
			...
			if (istype(M))
				...
				GLOB.death_event.register(M,src, /datum/event/exo_awakening::reduce_mob_count())
				GLOB.destroyed_event.register(M,src, /datum/event/exo_awakening::reduce_mob_count())
...
/datum/event/exo_awakening/proc/reduce_mob_count(mob/M)
	...
	GLOB.death_event.unregister(M,src, /datum/event/exo_awakening::reduce_mob_count())
	GLOB.destroyed_event.unregister(M,src, /datum/event/exo_awakening::reduce_mob_count())
