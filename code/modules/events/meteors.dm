...
/datum/event/meteor_wave/announce()
	switch(severity)
		if(EVENT_LEVEL_MAJOR)
			command_announcement.Announce("Meteors have been detected on collision course with the [station_name()].", "Sensor Array Automated Alert", new_sound = 'sound/AI/meteors.ogg')
		else
			command_announcement.Announce("The [station_name()] is now in a meteor shower.", "Sensor Array Automated Alert")
...
/datum/event/meteor_wave/end()
	switch(severity)
		if(EVENT_LEVEL_MAJOR)
			command_announcement.Announce("The [station_name()] has cleared the meteor storm.", "Sensor Array Automated Alert")
		else
			command_announcement.Announce("The [station_name()] has cleared the meteor shower", "Sensor Array Automated Alert")
