...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Space Bat Swarm",						/datum/event/bat_swarm,					25,		list(ASSIGNMENT_ENGINEER = 5, ASSIGNMENT_SECURITY = 5), 1)
	)
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Spider Infestation",				/datum/event/spider_infestation, 	0,	list(ASSIGNMENT_SECURITY = 35, ASSIGNMENT_MEDICAL = 5), 1),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Space Bat Swarm",					/datum/event/bat_swarm,				0,	list(ASSIGNMENT_ENGINEER = 10, ASSIGNMENT_SECURITY = 10, ASSIGNMENT_MEDICAL = 5), 1)
	)
