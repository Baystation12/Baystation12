...
/datum/event_container/mundane
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Distress Call",		/datum/event/distress,		 	20),
	)
...
//		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Solar Storm",				/datum/event/solar_storm, 				10,		list(ASSIGNMENT_ENGINEER = 20, ASSIGNMENT_SECURITY = 10), 1),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Distress Call",		/datum/event/distress,		 	20),
	)
...
/datum/event_container/major
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Distress Call",		/datum/event/distress,		 	20),
	)
