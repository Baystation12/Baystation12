...
/obj/item/clothing/suit/space/space_ninja/proc/lock_suit(mob/living/carbon/U, X = 0)
	if(X)//If you want to check for icons.
		...
		if(U.mind.special_role!="Space Ninja")
			U << "\red <B>fДTaL ИИRRoR</B>: 382200-*#00CЦDE <B>RED</B>\nUNAU†HORIZED USИ DETИC†††eD\nCoMMИNCING SUB-R0U†IN3 13...\nTИRMInATING U-U-USИR..."
			U.gib()
			return 0
			...
			switch(i)
				...
				if(3)
					if(U.stat==2||U.health<=0)
						U << "\red <B>FД†AL пїЅRrпїЅR</B>: 344--93#пїЅ&&21 BRпїЅпїЅN |/|/aVпїЅ PATT$RN <B>RED</B>\nA-A-aBпїЅrTпїЅNG..."
						unlock_suit()
						break
						...
						if(AI==A)
							switch(i)
								if(0)
									...
									U << "\red <b>WARNING</b>: HACKING ATпїЅпїЅTEMPпїЅ IN PR0GRESs!"
									spideros = 0
									k_unlock = 0
									U << browse(null, "window=spideros")
								if(1)
									A << "Disconnecting neural interface..."
									U << "\red <b>WARпїЅNING</b>: пїЅRпїЅO0пїЅGrпїЅ--S 2&3%"
								if(2)
									A << "Shutting down external protocol..."
									U << "\red <b>WARNING</b>: PпїЅпїЅпїЅпїЅRЦ†GrпїЅ5S 677^%"
									cancel_stealth()
								if(3)
									A << "Connecting to kernel..."
									U << "\red <b>WARNING</b>: пїЅRпїЅrпїЅR_404"
									A.control_disabled = 0
								if(4)
									A << "Connection established and secured. Menu updated."
									U << "\red <b>WпїЅr#nING</b>: #%@!!WИ†|_4пїЅ54@ \nUnпїЅB88l3 TпїЅ LпїЅ-пїЅo-LпїЅCaT2 ##$!пїЅRNпїЅ0..%.."
									grant_AI_verbs()
									return
							sleep(s_delay)
						else	break
...
/obj/item/clothing/suit/space/space_ninja/examine()
	...
	if(s_initialized)
		...
		if(s_control)
			...
			U <<  "пїЅrrпїЅR пїЅaпїЅпїЅaпїЅпїЅ No-пїЅ-пїЅ fпїЅпїЅNпїЅ 3RRпїЅr"
