...
/datum/event/money_lotto/announce()
	...
	var/body = "Nyx Daily wishes to congratulate <b>[winner_name]</b> for receiving the Nyx Stellar Slam Lottery, and receiving the out of this world sum of [winner_sum] [GLOB.using_map.local_currency_name]!"
	if(!deposit_success)
