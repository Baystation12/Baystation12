...
/datum/event/electrical_storm/announce()
	...
	switch(severity)
		...
		if(EVENT_LEVEL_MAJOR)
			command_announcement.Announce("Alert. A strong electrical storm has been detected in proximity of the station. It is recomended to immediately secure sensitive electrical equipment until the storm passes.", "Electrical Storm Alert")
