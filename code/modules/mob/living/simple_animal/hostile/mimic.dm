...
var/global/list/protected_objects = list(/obj/structure/table, /obj/structure/disposalpipe, /obj/structure/stairs, /obj/structure/ladder, /obj/structure/cable, /obj/structure/window, /obj/item/projectile/animate)
