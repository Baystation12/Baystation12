...
/mob/living/simple_animal/hostile/giant_spider/lurker/cloak()
	if(is_cloaked())
		return
...
/mob/living/simple_animal/hostile/giant_spider/lurker/uncloak()
...
/mob/living/simple_animal/hostile/giant_spider/lurker/break_cloak()
	uncloak()
