...
/mob/living/simple_animal/spiderbot/emag_act(var/remaining_charges, var/mob/user)
	if (emagged)
		...
		to_chat(user, "<span class='notice'>You short out the security protocols and overload [src]'s cell, priming it to explode in a short time.</span>")
			to_chat(spawn(100)	src, "<span class='danger'>Your cell seems to be outputting a lot of power...</span>")
			to_chat(spawn(200)	src, "<span class='danger'>Internal heat sensors are spiking! Something is badly wrong with your cell!</span>")
