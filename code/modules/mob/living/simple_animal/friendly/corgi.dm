...
/mob/living/simple_animal/corgi/Emelie
	name = "Emelie"
	real_name = "Emelie"
	gender = FEMALE
	desc = "It's a corgi with a cute pink bow."
...
//Emelie already has a cute bow!
/mob/living/simple_animal/corgi/Emelie/Topic(href, href_list)
	if(href_list["remove_inv"] || href_list["add_inv"])
		to_chat(usr, "<span class='warning'>[src] already has a cute bow!</span>")
		return
	..()

/mob/living/simple_animal/corgi/Emelie/Life()
	..()
