...
/mob/living/deity/proc/adjust_source(amount, atom/source, silent = FALSE, msg)
...
/mob/living/deity/proc/is_follower(mob/living/L, silent = FALSE)
	if(istype(L))
		if(L.mind)
...
/mob/living/deity/proc/near_structure(atom/A, all_structures = FALSE)
