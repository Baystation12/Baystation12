...
/datum/deity_item/general/potential/buy(mob/living/deity/D)
	..()
	D.adjust_power_min(5)

/datum/deity_item/general/potential/get_cost(mob/living/deity/D)
...
/datum/deity_item/general/regeneration/buy(mob/living/deity/D)
	..()
	D.power_per_regen++

/datum/deity_item/general/regeneration/get_cost(mob/living/deity/D)
