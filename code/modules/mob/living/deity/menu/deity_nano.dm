/mob/living/deity/var/menu_category
/mob/living/deity/var/list/nano_data = list()
/mob/living/deity/var/datum/phenomena/selected

/mob/living/deity/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = TRUE, uistate = GLOB.self_state)
