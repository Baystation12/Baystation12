...
/datum/phenomena/conversion/activate(var/mob/living/L)
	...
	if(choice == "Allow Conversion")
		godcult.add_antagonist_mind(L.mind,1,"a servant of [linked]. You willingly give your mind to it, may it bring you fortune", "Servant of [linked]", specific_god=linked)
	else
