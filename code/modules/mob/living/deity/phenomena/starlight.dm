	...
	if(href_list["herald"])
		...
		if(form["spells"])
			for(var/s in form["spells"])
				...
				L.add_spell(S)
		to_chat(L, SPAN_NOTICE("You have been chosen by your master to lead your fellow followers into the next age of rebirth.<br>You have been granted powerful armor and a powerful spell. Don't lose them, as they are your key to your divinity and leadership.<br>You also have particular sway over your deity's structures."))
...
/datum/phenomena/divine_right/activate(var/mob/living/L)
	...
	for(var/mob/living/player in GLOB.player_list)
		...
		if(player.mind && istype(player.mind.assigned_job, /datum/job/chaplain))
			...
			to_chat(player, SPAN_OCCULT("Your Master is being reborn into the body of \the [L]. Protect it at all costs."))
