...
/obj/structure/chorus/pylon/hear_talk(mob/M as mob, text, verb, datum/language/speaking)
	...
	if(owner.pylon != src)
		if(!(M in intuned))
			return
	to_chat(owner, "[bicon(src)] <span class='game say'><span class='name'>[M]</span> (<A href='?src=\ref[owner];jump=\ref[src];'>P</A>) [verb], [owner.pylon == src ? "<b>" : ""]<span class='message'><span class='body'>\"[text]\"</span></span>[owner.pylon == src ? "</b>" : ""]</span>")
