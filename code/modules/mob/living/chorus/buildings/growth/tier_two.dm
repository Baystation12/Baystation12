...
/datum/chorus_building/muscular_coat
	...
	build_time = 100
	build_level = 2
	resource_cost = list(/datum/chorus_resource/growth_meat = 15, /datum/chorus_resource/growth_bones = 5)
...
/datum/chorus_building/set_to_turf/growth/maw
	...
	build_level = 2
	range = 0
	resource_cost = list(/datum/chorus_resource/growth_meat = 10, /datum/chorus_resource/growth_bones = 10)
