...
/mob/living/silicon/ai/proc/available_icons()
	. = list()
	var/all_ai_icons = Singletons.GetSubtypeMap(/datum/ai_icon)
...
/mob/living/silicon/ai/proc/ai_hologram_change()
	...
	if(alert("Would you like to select a hologram based on a crew member or switch to unique avatar?",,"Crew Member","Unique")=="Crew Member")
		...
		var/holograms_by_type = Singletons.GetSubtypeMap(/singleton/ai_holo)
...
/mob/living/silicon/ai/on_update_icon()
	if(!selected_sprite || !(selected_sprite in available_icons()))
		selected_sprite = Singletons.GetInstance(default_ai_icon)
