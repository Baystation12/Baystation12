...
/mob/living/silicon/ai/New(loc, var/datum/ai_laws/L, var/obj/item/device/mmi/B, var/safety = 0)
	...
	add_language(LANGUAGE_HUMAN_LORRIMAN, 1)
...
/mob/living/silicon/ai/proc/on_mob_init()
	to_chat(src, "<B>Вы играете за Искусстенный Интеллект объекта [GLOB.using_map.station_ru]. ИИ не может перемещаться сам по себе, но можно взаимодействовать со множеством электронных объектов в момент, когда они находятся его зоне видимости (через камеры).</B>")
...
/mob/living/silicon/ai/proc/ai_announcement()
	...
	announcement.Announce(input, new_sound = 'proxima/sound/AI/attention.ogg')
	message_cooldown = 1
