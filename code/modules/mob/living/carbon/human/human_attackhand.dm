		...
		if(G.cell)
			if(M.a_intent == "hurt")//Stungloves. Any contact will stun the alien.
				if(G.cell.charge >= 2500)
					...
					M.attack_log += text("\[[time_stamp()]\] <font colour='red'>Stungloved [src.name] ([src.ckey])</font>")
					src.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has been stungloved by [M.name] ([M.ckey])</font>")
...
//			if(M.health < -75)	return 0
		...
		if("hurt")
			...
			M.attack_log += text("\[[time_stamp()]\] <font colour='red'>[M.species.attack_verb]ed [src.name] ([src.ckey])</font>")
			src.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has been [M.species.attack_verb]ed by [M.name] ([M.ckey])</font>")
		...
		if("disarm")
			M.attack_log += text("\[[time_stamp()]\] <font colour='red'>Disarmed [src.name] ([src.ckey])</font>")
			src.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has been disarmed by [M.name] ([M.ckey])</font>")
