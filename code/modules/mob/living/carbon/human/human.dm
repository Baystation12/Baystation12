...
/mob/living/carbon/human/ex_act(severity)
	...
	apply_damage(0.7 * b_loss, DAMAGE_BRUTE, null, DAM_EXPLODE, used_weapon = "Explosive blast")
	apply_damage(0.7 * f_loss, DAMAGE_BURN, null, DAM_EXPLODE, used_weapon = "Explosive blast")

	// distribute the remaining 30% on all limbs equally (including the one already dealt damage)
	apply_damage(0.3 * b_loss, DAMAGE_BRUTE, null, DAM_EXPLODE | DAM_DISPERSED, used_weapon = "Explosive blast")
	apply_damage(0.3 * f_loss, DAMAGE_BURN, null, DAM_EXPLODE | DAM_DISPERSED, used_weapon = "Explosive blast")
