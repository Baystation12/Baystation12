...
/mob/living/carbon/human/apply_damage(var/damage = 0, var/damagetype = BRUTE, var/def_zone = null, var/blocked = 0, var/sharp = 0, var/edge = 0, var/laser = 0, var/obj/used_weapon = null)
	...
	switch(damagetype)
		if(BRUTE)
			...
			if(organ.take_damage(damage, 0, sharp, edge, laser, used_weapon))
				UpdateDamageIcon()
		if(BURN)
			damageoverlaytemp = 20
			damage = damage*species.burn_mod
			if(organ.take_damage(0, damage, sharp, edge, laser, used_weapon))
				UpdateDamageIcon()
