...
/datum/species
	...
	var/name_language = LANGUAGE_ENGLISH       // The language to use when determining names for this species, or null to use the first name/last name generator
	...
	var/can_operate_heavy_covenant = 1 //This and the above are to specifically stop grunts from using certain rifles and yanme from using certain heavy weaponry.
