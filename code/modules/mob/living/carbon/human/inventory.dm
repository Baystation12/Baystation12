...
/obj/effect/equip_e/human/process()
	...
	if ((item && !( L.Find(place) )))
		...
		switch(place)
			...
			if("mask")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Had their mask removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) mask</font>")
			...
			if("l_hand")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their left hand item ([target.l_hand]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) left hand item ([target.l_hand])</font>")
				message = "\red <B>[source] is trying to take off \a [target.l_hand] from [target]'s left hand!</B>"
			if("r_hand")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their right hand item ([target.r_hand]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) right hand item ([target.r_hand])</font>")
				message = "\red <B>[source] is trying to take off \a [target.r_hand] from [target]'s right hand!</B>"
			if("gloves")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their gloves ([target.gloves]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) gloves ([target.gloves])</font>")
			...
			if("eyes")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their eyewear ([target.glasses]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) eyewear ([target.glasses])</font>")
			...
			if("l_ear")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their left ear item ([target.l_ear]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) left ear item ([target.l_ear])</font>")
			...
			if("r_ear")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their right ear item ([target.r_ear]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) right ear item ([target.r_ear])</font>")
			...
			if("head")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their hat ([target.head]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) hat ([target.head])</font>")
			...
			if("shoes")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their shoes ([target.shoes]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) shoes ([target.shoes])</font>")
			...
			if("belt")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their belt item ([target.belt]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) belt item ([target.belt])</font>")
				message = "\red <B>[source] is trying to take off the [target.belt] from [target]'s belt!</B>"
			if("suit")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their suit ([target.wear_suit]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) suit ([target.wear_suit])</font>")
			...
			if("back")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their back item ([target.back]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) back item ([target.back])</font>")
				message = "\red <B>[source] is trying to take off \a [target.back] from [target]'s back!</B>"
			if("handcuff")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Was unhandcuffed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to unhandcuff [target.name]'s ([target.ckey])</font>")
				message = "\red <B>[source] is trying to unhandcuff [target]!</B>"
			if("legcuff")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Was unlegcuffed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to unlegcuff [target.name]'s ([target.ckey])</font>")
				message = "\red <B>[source] is trying to unlegcuff [target]!</B>"
			if("uniform")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their uniform ([target.w_uniform]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) uniform ([target.w_uniform])</font>")
			...
			if("s_store")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their suit storage item ([target.s_store]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) suit storage item ([target.s_store])</font>")
				message = "\red <B>[source] is trying to take off \a [target.s_store] from [target]'s suit!</B>"
			if("pockets")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their pockets emptied by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to empty [target.name]'s ([target.ckey]) pockets</font>")
				for(var/obj/item/I in list(target.l_store, target.r_store))
					if(I.on_found(source))
						return
			...
			if("id")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their ID ([target.wear_id]) removed by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to remove [target.name]'s ([target.ckey]) ID ([target.wear_id])</font>")
				message = "\red <B>[source] is trying to take off [target.wear_id] from [target]'s uniform!</B>"
			if("internal")
				target.attack_log += text("\[[time_stamp()]\] <font colour='orange'>Has had their internals toggled by [source.name] ([source.ckey])</font>")
				source.attack_log += text("\[[time_stamp()]\] <font colour='red'>Attempted to toggle [target.name]'s ([target.ckey]) internals</font>")
				if (target.internal)
