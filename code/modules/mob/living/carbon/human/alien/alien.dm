...
proc/create_new_xenomorph(var/alien_caste,var/target)
	...
	var/mob/living/carbon/human/alien/new_alien = new(target)
	new_alien.set_species("Xenomorph [alien_caste]")
	return new_alien

//NEVER SPAWN THESE VIA THE SPAWN COMMAND. SPAWN THE DESCENDANTS INSTEAD.
/mob/living/carbon/human/alien
	...
	var/stored_plasma = 250

	status_flags = CANPARALYSE | CANPUSH

/mob/living/carbon/human/alien/drone/New(var/new_loc)
	h_style = "Bald"
	..(new_loc, "Xenomorph Drone")

/mob/living/carbon/human/alien/sentinel/New(var/new_loc)
	h_style = "Bald"
	..(new_loc, "Xenomorph Sentinel")

/mob/living/carbon/human/alien/hunter/New(var/new_loc)
	h_style = "Bald"
	..(new_loc, "Xenomorph Hunter")

/mob/living/carbon/human/alien/queen/New(var/new_loc)
	h_style = "Bald"
	..(new_loc, "Xenomorph Queen")

/mob/living/carbon/human/alien/Stat()
	...
	if (client.statpanel == "Status")
		...
		if(istype(species,/datum/species/xenos))
			...
			max_plasma = X.maximum_plasma
		stat(null, "Phoron Stored: [stored_plasma]/[max_plasma]")
