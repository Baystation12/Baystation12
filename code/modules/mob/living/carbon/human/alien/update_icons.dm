...
/mob/living/carbon/human/alien/update_icons()
...
/mob/living/carbon/human/alien/regenerate_icons()
	..()
...
/mob/living/carbon/human/alien/update_hud()
	//TODO
	if (client)
...
/mob/living/carbon/human/alien/update_inv_wear_suit(var/update_icons=1)
	if(wear_suit)
...
/mob/living/carbon/human/alien/update_inv_head(var/update_icons=1)
	if (head)
...
/mob/living/carbon/human/alien/update_inv_pockets(var/update_icons=1)
	if(l_store)		l_store.screen_loc = ui_storage1
	if(r_store)		r_store.screen_loc = ui_storage2
	if(update_icons)	update_icons()


/mob/living/carbon/human/alien/update_inv_r_hand(var/update_icons=1)
	if(r_hand)
...
/mob/living/carbon/human/alien/update_inv_l_hand(var/update_icons=1)
	if(l_hand)
...
/mob/living/carbon/human/alien/update_targeted(var/update_icons=1)
