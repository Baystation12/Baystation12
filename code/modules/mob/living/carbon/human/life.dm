			...
			if(config.rus_language)
				if(prob(3))
					switch(pick(1,2,3))
						...
						if(2)
							say(sanitize(pick("Êàê ìèí____255_òü ðóêè?","åáó÷èå ôóððè!", "Ïîäåáèë", "Ïðîêë____255_òûå òðàïû!", "ëîëêà!", "âæææææææææ!!!", "äæåô ñêâààààä!", "ÁÐÀÍÄÅÍÁÓÐÃ!", "ÁÓÄÀÏÅØÒ!", "ÏÀÓÓÓÓÓÊ!!!!", "ÏÓÊÀÍ ÁÎÌÁÀÍÓË!", "ÏÓØÊÀ", "ÐÅÂÀ ÏÎÖÎÍÛ", "Ïàòè íà õîïà!")))
						if(3)
							emote("drool")
			else
				if (prob(3))
