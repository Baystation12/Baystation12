...
/mob/living/carbon/standard_weapon_hit_effects(obj/item/I, mob/living/user, var/effective_force, var/hit_zone)
	...
	var/datum/wound/created_wound = apply_damage(effective_force, I.damage_type, hit_zone, damage_flags, used_weapon=I)

	//Melee weapon embedded object code.
	if(istype(created_wound) && I && I.can_embed() && I.damage_type == BRUTE && !I.anchored && !is_robot_module(I))
		...
		damage *= 1 - get_blocked_ratio(hit_zone, I.damage_type, I.damage_flags(), I.armor_penetration, I.force)
