...
/mob/living/carbon/slime/proc/invalidFeedTarget(var/mob/living/M)
	...
	if (M.get_blocked_ratio(null, TOX, damage_flags = DAM_DISPERSED) >= 1)
...
/mob/living/carbon/slime/proc/Feedon(var/mob/living/M)
	...
	while(Victim && stat != 2)
		if(Adjacent(M))
			...
			var/hazmat = 1 - M.get_blocked_ratio(null, TOX, damage_flags = DAM_DISPERSED) //scale feeding rate by overall bio protection
