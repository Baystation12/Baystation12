...
/mob/proc/do_skilled(base_delay, skill_path , atom/target = null, factor = 0.3, do_flags = DO_DEFAULT, list/additional_atoms)
	return do_after(src, base_delay * skill_delay_mult(skill_path, factor), target, do_flags, additional_atoms = additional_atoms)
