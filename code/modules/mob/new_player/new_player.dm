...
/mob/new_player/proc/LateChoices()
	...
	if(evacuation_controller.has_evacuated())
		header += "<font color='red'><b>[GLOB.using_map.station_ru] был эвакуирована.</b></font><br>"
	else if(evacuation_controller.is_evacuating())
		if(evacuation_controller.emergency_evacuation) // Emergency shuttle is past the point of no recall
			header += "<font color='red'>[GLOB.using_map.station_ru] в текущий момент эвакуируется.</font><br>"
		else                                           // Crew transfer initiated
			header += "<font color='red'>[GLOB.using_map.station_ru] в текущий момент перемещается в следующий сектор.</font><br>"
