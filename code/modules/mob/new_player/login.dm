...
/mob/new_player/Login()
	...
	spawn(40)
		...
		to_chat(usr, "<span class='notice'>The alert level on the [station_name()] is currently elevated to <font color=[SL.light_color_alarm]><B>[SL.name]</B></font>. [alert_desc]</span>")