...
/mob/proc/say_dead(var/message)
	...
	var/rendered = "<big><img src=\ref['icons/misc/dead.png']> </img></big><span class='game deadsay'><span class='name'>[name]</span>[alt_name] [pick("complains","moans","whines","laments","blubbers")], <span class='message'>\"[message]\"</span></span>"
