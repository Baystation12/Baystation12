...
/datum/language/human/euro
	...
	flags = WHITELISTED
	shorthand = "ZAC"
	partial_understanding = list(LANGUAGE_GALCOM = 5, LANGUAGE_HUMAN_IBERIAN = 30, LANGUAGE_HUMAN_CHINESE = 5, LANGUAGE_HUMAN_ARABIC = 5, LANGUAGE_HUMAN_INDIAN = 5, LANGUAGE_HUMAN_RUSSIAN = 5)

/datum/language/human/euro/syllables = list(
