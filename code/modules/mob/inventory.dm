...
//Force value is used when you are ABSOLUTELY CERTAIN you need to drop this and ignore unequip checks (For example, grabs can be "dropped" but only willingly)
/mob/proc/drop_item(var/atom/Target, force = FALSE)
