...
/datum/grab/nab/proc/crush(var/obj/item/grab/G, var/attack_damage)
	...
	if(prob(30))
		...
		G.affecting.apply_damage(hit_damage, DAMAGE_BRUTE, hit_zone, DAM_SHARP, used_weapon = "organic punctures")
...
/datum/grab/nab/proc/masticate(var/obj/item/grab/G, var/attack_damage)
	...
	G.affecting.apply_damage(attack_damage, DAMAGE_BRUTE, hit_zone, DAM_SHARP|DAM_EDGE, used_weapon = "mandibles")
