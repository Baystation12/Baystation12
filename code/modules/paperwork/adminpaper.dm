...
/obj/item/paper/admin/proc/updateDisplay()
	show_browser(usr, "<HTML><head><meta charset='utf-8'><meta charset='utf-8'><TITLE>[name]</TITLE></HEAD><BODY>[headerOn ? header : ""][info_links][stamps][footerOn ? footer : ""][interactions]</BODY></HTML>", "window=[name];can_close=0")
