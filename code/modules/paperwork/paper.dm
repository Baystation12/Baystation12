...
/obj/item/weapon/paper/warden
	name = "Armoury Inventory"
	info = "<center><Large><b>NSS Exodus</b></large><br> <small>Armoury Inventory</small></center> <hr> <hr> <br> <b>Weaponry</b><br> <span class=\"paper_field\"></span> Energy Gun(s)<br> <span class=\"paper_field\"></span> Laser Gun(s)<br> <span class=\"paper_field\"></span> Ion Rifle(s)<br> <span class=\"paper_field\"></span> Combat Shotgun(s) <hr> <b>Armour</b><br> <span class=\"paper_field\"></span> Bulletproof Vest(s)<br> <span class=\"paper_field\"></span> Abalative Vest(s)<br> <span class=\"paper_field\"></span> Biohazard Suit(s)<br> <span class=\"paper_field\"></span> Bomb Suit(s) <hr> <b>Auxiliary Equipment</b><br> <span class=\"paper_field\"></span> Gasmask(s)<br> <span class=\"paper_field\"></span> box(es) of Flashbangs<br> <span class=\"paper_field\"></span> box(es) of Handcuffs<br> <span class=\"paper_field\"></span> box(es) of R.O.B.U.S.T. Cartridges <hr> <b>Riot Equipment</b><br> <span class=\"paper_field\"></span> Stun Baton(s)<br> <span class=\"paper_field\"></span> Riot Suit(s)<br> <span class=\"paper_field\"></span> Riot Shield(s) <hr> <b>Tactical Equipment</b><br> <span class=\"paper_field\"></span> Tactical Armour(s)<br> <span class=\"paper_field\"></span> Tactical Helmet(s)<br> <span class=\"paper_field\"></span> Tactical Jumpsuit(s)<br> <span class=\"paper_field\"></span> Green Balaclava(s)<br> <span class=\"paper_field\"></span> Tactical HUD(s)<br> <span class=\"paper_field\"></span> Combat Belt(s)<br> <span class=\"paper_field\"></span> Black Glove(s)<br> <span class=\"paper_field\"></span> Jackboot(s) <hr> <b>Implants</b><br> <span class=\"paper_field\"></span> Tracking Implant Box(es)<br> <span class=\"paper_field\"></span> Chemical Implant Box(es) <hr> <b>Defense Systems</b><br> <span class=\"paper_field\"></span> Deployable Barrier(s)<br> <span class=\"paper_field\"></span> Portable Flasher(s) <hr> <b>Other</b><br> <span class=\"paper_field\"></span> Holobadge Box(es) <hr> <b><center>Warden's's Signature:</b> <span class=\"paper_field\"></span></center> <hr>"
	fields = 29
...
/obj/item/weapon/paper/cmo
	...
	desc = "A few notes scratched out by the last CMO before they departed the station."
