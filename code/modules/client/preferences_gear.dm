...
/datum/gear/prescription_hipster
...
/datum/gear/suit_navy
	display_name = "suit, navy"
	path = /obj/item/clothing/under/suit_jacket/navy
	slot = slot_w_uniform
	cost = 1

/datum/gear/suit_oldman
	display_name = "suit, oldman"
	path = /obj/item/clothing/under/lawyer/oldman
	slot = slot_w_uniform
	cost = 1

/datum/gear/suit_purple
...
/datum/gear/dispatchersecsuit
	display_name = "uniform, dispatcher (Security)"
...
/datum/gear/slippers_shoes
	display_name = "shoes, slippers"
