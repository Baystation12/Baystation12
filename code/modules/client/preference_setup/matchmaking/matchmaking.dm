...
/datum/matchmaker/proc/do_matchmaking()
	...
	for(var/mob/M in to_warn)
		to_chat(M,"<span class='warning'>You have new connections. Use 'See Relationship Info' to view and finalize them. \
		A quick way to do this, is to type 'relationship', and hit space to autocomplete while in hotkey mode.</span>")
