...
/datum/category_item/player_setup_item/general/eros/content(var/mob/user)
	...
	. += "<b>Chest Color</b><br>"
	. += "<a href='?src=\ref[src];boobs_color=1'>Change Color</a> <font face='fixedsys' size='3' color='#[num2hex(pref.r_boobs, 2)][num2hex(pref.g_boobs, 2)][num2hex(pref.b_boobs, 2)]'><table style='display:inline;' bgcolor='#[num2hex(pref.r_boobs, 2)][num2hex(pref.g_boobs, 2)][num2hex(pref.b_boobs)]'><tr><td>__</td></tr></table></font><br>"
	. += "<br>"
