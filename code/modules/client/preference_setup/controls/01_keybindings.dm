/// Custom Keybindings
/datum/preferences/var/list/key_bindings = list()
/datum/preferences/var/hotkeys = TRUE
...
/datum/preferences/proc/announce_conflict(list/notadded)
	to_chat(client, SPAN_DANGER("KEYBINDING CONFLICT.<br/>\
	There are new keybindings that have defaults bound to keys you already set, They will default to Unbound. You can bind them in Setup Character or Game Preferences<br/>\
...
/datum/category_item/player_setup_item/controls/keybindings/proc/capture_keybinding(mob/user, datum/keybinding/kb, old_key)
	var/HTML = {"
	<div id='focus' style="outline: 0; text-align:center;" tabindex=0>
