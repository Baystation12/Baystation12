...
/datum/client_preference/play_lobby_music/toggled(var/mob/preference_mob, var/enabled)
	if(enabled)
		...
		to_chat(preference_mob, sound(null, repeat = 0, wait = 0, volume = 85, channel = 1))
...
/datum/client_preference/play_ambiance/toggled(var/mob/preference_mob, var/enabled)
	if(!enabled)
		to_chat(preference_mob, sound(null, repeat = 0, wait = 0, volume = 0, channel = 1))
		to_chat(preference_mob, sound(null, repeat = 0, wait = 0, volume = 0, channel = 2))
