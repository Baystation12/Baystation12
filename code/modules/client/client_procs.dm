...
/client/proc/update_hotkey_mode()
	if (prefs.hotkeys)
		...
		winset(src, "input", "background-color = [COLOR_DARKMODE_BACKGROUND]; background-color = #ffffff")
		...
		winset(src, "input", "text-color = #000000; background-color = #d3b5b5; focus=true")
