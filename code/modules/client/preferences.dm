...
datum/preferences
	...
	//game-preferences	var/lastchangelog = ""				//Saved changlog filesize to detect if there was a change	var/ooccolor = "#b82e00"
...
/datum/preferences	New()
	...
	proc/ShowChoices(mob/user)
		...
		dat += "\t<a href='?_src_=prefs;preference=job;task=menu'><b>Set Preferences</b></a><br>"		if(jobban_isbanned(user, "Records"))
		...
		dat += "<br>"
		dat += "Species: <a href='byond://?src=\ref[user];preference=species;task=input'>[species]</a><br>"		dat += "Blood Type: <a href='byond://?src=\ref[user];preference=b_type;task=input'>[b_type]</a><br>"
		...
		switch(href_list["task"])
			if("random")
				switch(href_list["preference"])
					...
					if("b_type")						b_type = pick( 31;"A+", 7;"A-", 8;"B+", 2;"B-", 2;"AB+", 1;"AB-", 40;"O+", 9;"O-" )					if("hair")
						r_hair = rand(0,255)
						g_hair = rand(0,255)
						b_hair = rand(0,255)
					if("h_style")
