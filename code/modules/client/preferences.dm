...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	dat += "</html></body>"
	var/datum/browser/popup = new(user, "Character Setup","Character Setup", 1600, 800, src)
...
/datum/preferences/proc/copy_to(mob/living/carbon/human/character, is_preview_copy = FALSE)
	...
	character.fully_replace_character_name(species.apply_species_name_formatting(real_name))
