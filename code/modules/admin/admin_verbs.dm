...
var/list/admin_verbs_default = list(
	/datum/admin/proc/show_player_panel,	//shows an interface for individual players, with various links (links require additional flags,
...
//	/datum/admin/proc/show_traitor_panel,	//interface which shows a mob's mind, -Removed due to rare practical use. Moved to debug verbs ~Errorage,
	/datum/admin/proc/show_game_mode,  //Configuration window for the current game mode.,
	/datum/admin/proc/force_mode_latespawn, //Force the mode to try a latespawn proc,
	/datum/admin/proc/force_antag_latespawn, //Force a specific template to try a latespawn proc,
	/datum/admin/proc/toggleenter,		//toggles whether people can join the current game,
	/datum/admin/proc/toggleguests,	//toggles whether guests can join the current game,
	/datum/admin/proc/announce,		//priority announce something to all clients.,
	/client/proc/colorooc,				//allows us to set a custom colour for everythign we say in ooc,
	/client/proc/admin_ghost,			//allows us to ghost/reenter body at will,
	/client/proc/toggle_view_range,		//changes how far we can see,
	/datum/admin/proc/view_txt_log,	//shows the server log (diary) for today,
	/datum/admin/proc/view_atk_log,	//shows the server combat-log, doesn't do anything presently,
...
//	/client/proc/toggle_hear_deadcast,	//toggles whether we hear deadchat,
	...
	/datum/admin/proc/toggleooc,		//toggles ooc on/off for everyone,
	/datum/admin/proc/toggleaooc,		//toggles aooc on/off for everyone,
	/datum/admin/proc/togglelooc,		//toggles looc on/off for everyone,
	/datum/admin/proc/toggleoocdead,	//toggles ooc on/off for everyone who is dead,
	/datum/admin/proc/toggledsay,		//toggles dsay on/off for everyone,
	/client/proc/game_panel,			//game panel, allows to change game-mode etc,
	/client/proc/cmd_admin_say,			//admin-only ooc chat,
	/datum/admin/proc/togglehubvisibility, //toggles visibility on the BYOND Hub,
	/datum/admin/proc/PlayerNotes,
	/client/proc/cmd_mod_say,
	/datum/admin/proc/show_player_info,
...
var/list/admin_verbs_fun = list(
	...
	/datum/admin/proc/ai_hologram_set
	)

var/list/admin_verbs_spawn = list(
	/datum/admin/proc/spawn_fruit,
	/datum/admin/proc/spawn_fluid_verb,
	/datum/admin/proc/spawn_custom_item,
	/datum/admin/proc/check_custom_items,
	/datum/admin/proc/spawn_plant,
	/datum/admin/proc/spawn_atom,		// allows us to spawn instances,
...
var/list/admin_verbs_server = list(
	/datum/admin/proc/capture_map_part,
...
var/list/admin_verbs_debug = list(
	...
	/client/proc/dsay,
	/datum/admin/proc/run_unit_test,
	/turf/proc/view_chunk,
	/turf/proc/update_chunk,
	/datum/admin/proc/capture_map,
...
var/list/admin_verbs_mod = list(
	...
	/client/proc/dsay,
	/datum/admin/proc/show_skills,
	/datum/admin/proc/show_player_panel,
	/client/proc/check_antagonists,
	/client/proc/cmd_admin_subtle_message, // send an message to somebody as a 'voice in their head',
	/client/proc/aooc,
	/datum/admin/proc/sendFax,
	/datum/admin/proc/paralyze_mob,
...
/client/proc/readmin_self()
	...
	if(deadmin_holder)
		readmin()
		log_and_message_admins("[src] re-admined themself.")
		to_chat(src, "<span class='interface'>You now have the keys to control the universe, or at least [GLOB.using_map.full_name].</span>")
