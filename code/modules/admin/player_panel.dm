...
/datum/admins/proc/check_antagonists()
	if (ticker && ticker.current_state >= GAME_STATE_PLAYING)
		...
		dat += "Round Duration: <B>[round(world.time / 36000)]:[(world.time / 600 % 60) < 10 ? add_zero(world.time / 600 % 60, 1) : world.time / 600 % 60]:[world.time / 100 % 6][world.time / 100 % 10]</B><BR>"
