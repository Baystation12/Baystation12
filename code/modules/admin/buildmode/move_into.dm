...
/datum/build_mode/move_into/proc/SetDestination(atom/A)
	...
	destination = A
	GLOB.destroyed_event.register(destination, src, /datum/build_mode/move_into::ClearDestination())
...
/datum/build_mode/move_into/proc/ClearDestination(feedback)
	...
	GLOB.destroyed_event.unregister(destination, src, /datum/build_mode/move_into::ClearDestination())
	destination = null
	if(feedback)
