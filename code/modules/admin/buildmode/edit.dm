...
/datum/build_mode/edit/proc/SetValue(new_value)
	...
	GLOB.destroyed_event.register(value_to_set, src, /datum/build_mode/edit::ClearValue())


/datum/build_mode/edit/proc/ClearValue(feedback)
	if (!istype(value_to_set, /datum))
		return
	GLOB.destroyed_event.unregister(value_to_set, src, /datum/build_mode/edit::ClearValue())
