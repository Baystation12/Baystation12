...
/datum/build_mode/relocate_to/proc/SetRelocator(new_relocator)
	...
	GLOB.destroyed_event.register(to_relocate, src, /datum/build_mode/relocate_to::ClearRelocator())
...
/datum/build_mode/relocate_to/proc/ClearRelocator(feedback)
	...
	GLOB.destroyed_event.unregister(to_relocate, src, /datum/build_mode/relocate_to::ClearRelocator())
	to_relocate = null
	if(feedback)
