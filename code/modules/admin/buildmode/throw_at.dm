...
/datum/build_mode/throw_at/proc/SetThrowable(new_throwable)
	...
	GLOB.destroyed_event.register(to_throw, src, /datum/build_mode/throw_at::ClearThrowable())
...
/datum/build_mode/throw_at/proc/ClearThrowable(feedback)
	...
	GLOB.destroyed_event.unregister(to_throw, src, /datum/build_mode/throw_at::ClearThrowable())
	to_throw = null
	if(feedback)
