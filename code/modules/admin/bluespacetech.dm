...
/client/proc/cmd_dev_bst()
	...
	bst.add_language(LANGUAGE_ROOTLOCAL)
	bst.add_language(LANGUAGE_ROOTGLOBAL)
	...
	bst.add_language(LANGUAGE_NABBER)
	bst.add_language(LANGUAGE_ADHERENT)
	...
	bst.add_language(LANGUAGE_ALIUM)
	bst.add_language()
	bst.add_language()
	bst.add_language("Xenophage")
