...
/client/verb/adminhelp(msg as text)
	...
	if(prefs.muted & MUTE_ADMINHELP)
		src << "<font colour='red'>Error: Admin-PM: You cannot send adminhelps (Muted).</font>"
		return
	...
	**/
					...
					if(found)
						if(!(found in mobs_found))
							...
							if(!ai_found && isAI(found))
								ai_found = 1
							msg += "<b><font colour='black'>[original_word] (<A HREF='?_src_=holder;adminmoreinfo=\ref[found]'>?</A>)</font></b> "
							continue
			msg += "[original_word] "
	...
	src << "<font colour='blue'>PM to-<b>Admins</b>: [original_msg]</font>"
