...
var/global/list/debug_verbs = list (
		...
		, /client::cmd_assume_direct_control()
		, /client::startSinglo()
		, /client::cmd_admin_grantfullaccess()
		, /client::cmd_admin_areatest()
		, /client::cmd_admin_rejuvenate()
		, /datum/admins::show_traitor_panel()
		, /client::print_jobban_old()
		, /client::print_jobban_old_filter()
		, /client::forceEvent()
		, /client::Zone_Info()
		, /client::Test_ZAS_Connection()
		, /client::rebootAirMaster()
		, /client::hide_debug_verbs()
		, /client::testZAScolors()
		, /client::testZAScolors_remove()
		, /datum/admins::setup_supermatter()
		, /client::atmos_toggle_debug()
		, /client::spawn_tanktransferbomb()
		, /client::find_leaky_pipes()
		, /client::analyze_openturf()
	)
