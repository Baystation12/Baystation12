	...
	for (var/mob/M in world)
		if (M.client && M.client.holder && M.client.holder.level != 0) //Moderators cannot see it.
			if (src.holder.rank == "Admin Observer")
				...
				M << "<span class='adminchat'><span class='prefix'>ADMIN:</span> <EM>[key_name(usr, M)]</EM> (<A HREF='?src=\ref[M.client.holder];adminplayerobservejump=\ref[mob]'>JMP</A>): <span class='message'>[msg]</span></span>"
