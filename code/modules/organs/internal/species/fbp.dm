...
/obj/item/organ/internal/mmi_holder/take_internal_damage(var/damage, var/silent)
	..()
...
/obj/item/organ/internal/stomach/reactor
	name = "internal reactor"
	icon_state = "innards"
	organ_tag = BP_REACTOR
	parent_organ = BP_GROIN

/obj/item/organ/internal/stomach/reactor/Process()
	..()

/obj/item/organ/internal/stomach/reactor/metabolize()
	if(!owner.isSynthetic() || !is_usable() || !ingested)
		return
