...
/decl/cultural_info/culture/human/martian_surfacer
	...
	are known as Monsians, and these represent the largest cultural group on the planet. Most surfacers have had a decent upbringing and represent the \
...
/decl/cultural_info/culture/human/martian_tunneller
	...
	description = "You are one of the people of the under cities of Mars. The under cities, built originally as 'temporary' living space while the cities above them \
	...
	to the same amenities and services as surfacers are somewhat poorer than their above-ground brethren as a result of their less desirable locale as well as a strong \
	criminal presence as a result of centuries of poor policing and a focus on the surface by the martian government. Most tunnellers are resilient, though distrusting \
...
/decl/cultural_info/culture/human/luna_poor
	...
	description = "You are from Luna, a natural satellite of Earth and home to some of the richest and most cultured people humanity has. Unfortunately, you are most certainly not one of them. \
...
/decl/cultural_info/culture/human/luna_rich
	...
	description = "You are from Luna, Earths only satellite and home to some of the richest, cultured, or influential people of humanity. Fortunately for you, you are one of this elite and well \
	off class of people. The rich of Luna are influential, politically and economically, not over just their own home, but also the various corporations, governments and government bodies of the SCG. \
	Not all of the upper class Lunarites consider themselves equal to others however, with them being generally divided along lines of 'new' money and 'old' money, 'corporate' and 'individual' \
	with many those belonging to the old, family dynasties of Luna looking down on the new corporate wealthy. Much of the elite of Luna are constantly embroiled in the 'Game' a state of political \
	manoeuvring and intrigue between various factions and persons of influence and power that goes far beyond the squabbles of the prefectures."
...
/decl/cultural_info/culture/human/venusian_upper
	...
	description = "You are from the many zones of Venus. Floating high above the ground of the planet on massive platforms, you are one of the many who live on one of the most decadent locations in the \
...
/decl/cultural_info/culture/human/plutonian
	...
	much of the planets infrastructure being unstable or outright falling apart. This, coupled with rampant corruption and the large influence of criminal organisations across much of \
	the planet has led to the people of Pluto having something of a seedy reputation and those holding citizenship are viewed with disrepute. The people themselves, however, are usually \
...
/decl/cultural_info/culture/human/earthling
	...
	The long recovery period of Earth has resulted in much of the population being environmentally aware and heavily conservationist, eager to avoid past mistakes. Most earthlings are \
...
/decl/cultural_info/culture/human/ceti
	...
	Putting education and the latest tech at the forefront of their priorities the people of Ceti are some of the brightest or tech savvy around. This, coupled with their \
	...
	cybernetics culture. As such it is not uncommon to see many cetites sporting some chrome."
	secondary_langs = list(LANGUAGE_SOL_COMMON, LANGUAGE_SPACER)
	economic_power = 1.1
...
/decl/cultural_info/culture/human/spacer_core
	...
	places, meeting a myriad of people and experiencing many of the cultures and worlds close to humanities home. As such, spacers of the core systems tend to be busy, sociable and \
...
/decl/cultural_info/culture/human/confederate
	...
	Unfortunately, the years since the war have not been easy on Terra and the long period of economic recovery have not made life easy. The people of Terra are typically employed largely \
...
/decl/cultural_info/culture/human/other
	...
	description = "Some people are from places noone has ever heard of or places too wild and fantastical to make it into Encyclopedia Galactica. You are one of these. "
	secondary_langs = list(LANGUAGE_SOL_COMMON, LANGUAGE_SIGN)
	economic_power = 1
