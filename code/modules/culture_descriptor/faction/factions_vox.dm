/decl/cultural_info/faction/vox
	...
	description = "Most vox are content to live and work on the arkships, serving their allotted span under the watchful \
	...
	the general day-to-day energy exhibited by all vox. The average ark laborer is not ambitious, and knows things could \
	be a lot worse."
