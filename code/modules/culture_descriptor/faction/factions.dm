...
/decl/cultural_info/faction/torchco
	name = FACTION_TENJIN
	description = "Tenjin Holdings is a government-owned, publically traded limited liability company assembled from the corporate \
	...
	Hephaestus Industries, as well as dozens of others. Tenjin Holdings reports its earnings and operation plans directly to a board of \
	...
	While on the surface Tenjin Holdings appears to have noble goals, it is in reality a compromise between the noble ideals of pioneering \
