/decl/cultural_info/location/human
	...
	description = "Mars, the current capital of the SCG, known by its nickname the Red Planet, is one of the most populous centers of Humanity. \
...
/decl/cultural_info/location/human/luna
	...
	is a center of culture, the arts, trade and politics and it is from here the people of Luna take the name of their language 'Selenian'. \
...
/decl/cultural_info/location/human/venus
	...
	of their employment. The second group, the surfacers are hardy laborers who work in large, windowless, industrial complexes on the planets \
...
/decl/cultural_info/location/human/ceres
	...
	Operated primarily by Falco Designs, one of the SCG's premier shipbuilding corporations, Ceres is home to a multitude of drydocks and service centers \
...
/decl/cultural_info/location/human/pluto
	...
	syndicates. In spite of a number of modernization efforts the Pluto of today has seen very little in the way of improvement.<br><br>The people \
...
/decl/cultural_info/location/human/cetiepsilon
	...
	description = "Ceti Epsilon, the only habitable planet in the Tau Ceti system, is home to its largest population center. \
...
/decl/cultural_info/location/human/eos
	...
	Fleet and law enforcement outposts, government services and a wide array of private enterprises all catering to the many hangabouts, travelers, merchants and soldiers who pass through it daily. \
	This fact alone is what has allowed the Helios system and Eos as a whole to weather multiple economic recessions and has allowed Eos to establish itself as a premier commercial center of the wider \
...
/decl/cultural_info/location/human/terra
	...
	non-human presence. Much of Terra is heavily industrialized, with a lower standard of living than on equivalent SCG planets. Much of the population works in services, industry or the military. \
...
/decl/cultural_info/location/human/lorriman
	...
	It is known by most Defense Forces personnel to act begrudgingly towards any requests given, and only a select few have visited the planet itself.<br><br>\
	...
	to the planet, but exceptions have been made. A scientifically driven people, they have served many organizations loyally."
	capital = "The Hub"
	economic_power = 1.0
...
/decl/cultural_info/location/human/cinu
	...
	with many refusing to participate in the Defense Forces. Instead, they serve as peacekeepers and diplomats. The Cinuan People were controversially non-aligned during the Gaian Conflict."
	capital = "Al-Mular"
	economic_power = 1.0
