/namespace/synthesized_instruments/player/synthesizer
	forced_sound_in = 0
...
/obj/structure/synthesized_instrument/synthesizer
	...
	anchored = 1
	density = 1
	var/namespace/synthesized_instruments/instrument/instruments = list()
	...
	switch (target)
		...
		if ("instrument")
			...
			for (var/key in instruments)
				var/namespace/synthesized_instruments/instrument/instrument = instruments[key]
...
/obj/structure/synthesized_instrument/synthesizer/mindbreaker
	New()
		..()
		qdel(src.player)
		src.player = new /namespace/synthesized_instruments/player/synthesizer/torture(src, instruments[pick(instruments)])