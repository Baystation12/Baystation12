...
/namespace/synthesized_instruments/bound/proc/in_bounds(val)
	return (val in src.min to src.max) && (!src.is_integer || round(val) == val)
...
/namespace/synthesized_instruments/bounds
	...
	var/namespace/synthesized_instruments/bound/octave_bounds = new /namespace/synthesized_instruments/bound{min = 0; max = 9; is_integer = 1}
	// Specifies min and max transposition possible. No point in having it outside of -9 to 9.
	var/namespace/synthesized_instruments/bound/transposition_bounds = new /namespace/synthesized_instruments/bound{min = -9; max = 9; is_integer = 1}
...
/namespace/synthesized_instruments/environment
	...
	var/list/namespace/synthesized_instruments/bound/env_params_bounds = newlist(
			/namespace/synthesized_instruments/bound{min = 1.0; max = 100.0; is_integer = 0}, // 1
			/namespace/synthesized_instruments/bound{min = 0.0; max = 1.0; is_integer = 0}, // 2
			/namespace/synthesized_instruments/bound{min = -10000; max = 0; is_integer = 1}, // 3
			/namespace/synthesized_instruments/bound{min = -10000; max = 0; is_integer = 1}, // 4
			/namespace/synthesized_instruments/bound{min = -10000; max = 0; is_integer = 1}, // 5
			/namespace/synthesized_instruments/bound{min = 0.1; max = 20; is_integer = 0}, // 6
			/namespace/synthesized_instruments/bound{min = 0.1; max = 2.0; is_integer = 0}, // 7
			/namespace/synthesized_instruments/bound{min = 0.1; max = 2.0; is_integer = 0}, // 8
			/namespace/synthesized_instruments/bound{min = -10000; max = 1000; is_integer = 1}, // 9
			/namespace/synthesized_instruments/bound{min = 0.0; max = 0.3; is_integer = 0}, // 10
			/namespace/synthesized_instruments/bound{min = -10000; max = 2000; is_integer = 1}, // 11
			/namespace/synthesized_instruments/bound{min = 0.1; max = 0; is_integer = 0}, // 12
			/namespace/synthesized_instruments/bound{min = 0.075; max = 0.250; is_integer = 0}, // 13
			/namespace/synthesized_instruments/bound{min = 0.0; max = 1.0; is_integer = 0}, // 14
			/namespace/synthesized_instruments/bound{min = 0.04; max = 4.0; is_integer = 0}, // 15
			/namespace/synthesized_instruments/bound{min = 0.0; max = 1.0; is_integer = 0}, // 16
			/namespace/synthesized_instruments/bound{min = -100.0; max = 0.0; is_integer = 0}, // 17
			/namespace/synthesized_instruments/bound{min = 1000.0; max = 20000.0; is_integer = 0}, // 18
			/namespace/synthesized_instruments/bound{min = 20.0; max = 1000.0; is_integer = 0}, // 19
			/namespace/synthesized_instruments/bound{min = 0.0; max = 10.0; is_integer = 0}, // 20
			/namespace/synthesized_instruments/bound{min = 0.0; max = 100.0; is_integer = 0}, // 21
			/namespace/synthesized_instruments/bound{min = 0.0; max = 100.0; is_integer = 0}, // 22
			/namespace/synthesized_instruments/bound{min = 0x00; max = 0xFF; is_integer = 1}) // 23
	// Ditto
...
/namespace/synthesized_instruments/echo
	...
	var/list/namespace/synthesized_instruments/bound/echo_params_bounds = newlist(
			/namespace/synthesized_instruments/bound{min = -10000; max = 1000; is_integer = 1}, // 1
			/namespace/synthesized_instruments/bound{min = -10000; max = 0; is_integer = 1}, // 2
			/namespace/synthesized_instruments/bound{min = -10000; max = 1000; is_integer = 1}, // 3
			/namespace/synthesized_instruments/bound{min = -10000; max = 0; is_integer = 1}, // 4
			/namespace/synthesized_instruments/bound{min = -10000; max = 0; is_integer = 1}, // 5
			/namespace/synthesized_instruments/bound{min = 0.0; max = 1.0; is_integer = 0}, // 6
			/namespace/synthesized_instruments/bound{min = -10000; max = 0; is_integer = 1}, // 7
			/namespace/synthesized_instruments/bound{min = 0.0; max = 1.0; is_integer = 0}, // 8
			/namespace/synthesized_instruments/bound{min = 0.0; max = 10.0; is_integer = 0}, // 9
			/namespace/synthesized_instruments/bound{min = 0.0; max = 10.0; is_integer = 0}, // 10
			/namespace/synthesized_instruments/bound{min = -10000; max = 0; is_integer = 1}, // 11
			/namespace/synthesized_instruments/bound{min = 0.0; max = 1.0; is_integer = 0}, // 12
			/namespace/synthesized_instruments/bound{min = -10000; max = 0; is_integer = 1}, // 13
			/namespace/synthesized_instruments/bound{min = 0.0; max = 10.0; is_integer = 0}, // 14
			/namespace/synthesized_instruments/bound{min = 0.0; max = 10.0; is_integer = 0}, // 15
			/namespace/synthesized_instruments/bound{min = 0.0; max = 10.0; is_integer = 0}, // 16
			/namespace/synthesized_instruments/bound{min = 0.0; max = 10.0; is_integer = 0}, // 17
			/namespace/synthesized_instruments/bound{min = 0x0; max = 0x8; is_integer = 1}) // 18
	// Alpha
...
/namespace/synthesized_instruments/shared/New()
	...
	for (var/i=1 to GLOB.synthesized_instruments.enums.BYOND_MAX_CHANNELS)
...
/namespace/synthesized_instruments/functions/proc/environment_to_id(environment)
	if (environment in src.all_environments)
		return src.all_environments.Find(environment) - GLOB.synthesized_instruments.enums.INDEX_TO_ID_DIFF
	return GLOB.synthesized_instruments.enums.MIN_ENV_ID


/namespace/synthesized_instruments/functions/proc/id_to_environment(id)
	if (GLOB.synthesized_instruments.enums.MIN_ENV_ID <= id && GLOB.synthesized_instruments.enums.CUSTOM_ENV_ID >= id)
		return src.all_environments[id+GLOB.synthesized_instruments.enums.INDEX_TO_ID_DIFF]
	return "None"


/namespace/synthesized_instruments/functions/proc/index_to_id(index)
	var/bounded = min(index-GLOB.synthesized_instruments.enums.INDEX_TO_ID_DIFF, GLOB.synthesized_instruments.enums.CUSTOM_ENV_ID)
	bounded = max(bounded, GLOB.synthesized_instruments.enums.MIN_ENV_ID)
	return bounded
