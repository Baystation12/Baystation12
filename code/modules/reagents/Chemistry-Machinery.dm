...
/obj/machinery/chem_dispenser/soda
	...
	var/list/hidden_reagents = list("thirteenloko","grapesoda")
	...
	/obj/machinery/chem_dispenser/soda/attackby(var/obj/item/weapon/B as obj, var/mob/user as mob)
		...
		if(istype(B, /obj/item/device/multitool))
			if(hackedcheck == 0)
				...
				dispensable_reagents += hidden_reagents
				hackedcheck = 1
				return
...
/obj/machinery/chem_dispenser/beer
	...
	var/list/hidden_reagents = list("goldschlager","patron","watermelonjuice","berryjuice")
