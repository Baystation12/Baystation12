...
/datum/chemical_reaction/phlogiston/on_reaction(var/datum/reagents/holder, var/created_volume)
	...
	holder.del_reagent("Phlogiston")

/datum/chemical_reaction/napalm
	name = "Napalm"
	result = /datum/reagent/napalm
	required_reagents = list(/datum/reagent/aluminum = 1, /datum/reagent/acid = 1, /datum/reagent/drink/juice/banana = 1 ) //because bananas grow on palms and palm oil is used to make napalm. =/= logic
	result_amount = 2

/datum/chemical_reaction/napalmb
	name = "Napalm B"
	result = /datum/reagent/napalmb
