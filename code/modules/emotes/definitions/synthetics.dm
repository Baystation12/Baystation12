...
/decl/emote/audible/synth/buzz
	...
	emote_sound = list(
		EMOTE_ALL_SPECIES = list(EMOTE_ALL_GENDERS = list('sound/machines/buzz-sigh.ogg')))

/decl/emote/audible/synth/confirm
	key = "confirm"
	emote_message_3p = "USER emits an affirmative blip."
	emote_sound = list(
		EMOTE_ALL_SPECIES = list(EMOTE_ALL_GENDERS = list('sound/machines/synth_yes.ogg')))

/decl/emote/audible/synth/deny
	key = "deny"
	emote_message_3p = "USER emits a negative blip."
	emote_sound = list(
		EMOTE_ALL_SPECIES = list(EMOTE_ALL_GENDERS = list('sound/machines/synth_no.ogg')))
