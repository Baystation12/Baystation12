...
#define PROCESS_DEFAULT_HANG_WARNING_TIME 	500 // 50 seconds
#define PROCESS_DEFAULT_HANG_ALERT_TIME 	900 // 90 seconds
#define PROCESS_DEFAULT_HANG_RESTART_TIME   1200 // 120 seconds
