...
#define BP_FBP_STOMACH  "fuel processor"
...
#define SPECIES_PROSTHETIC  "Human (Prosthetic Body)"

#define STATION_SPECIES list(SPECIES_HUMAN, SPECIES_DIONA, SPECIES_IPC, SPECIES_UNATHI, SPECIES_SKRELL, SPECIES_TRITONIAN, SPECIES_SPACER, SPECIES_VATGROWN, SPECIES_GRAVWORLDER, SPECIES_PROSTHETIC)
