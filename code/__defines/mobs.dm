...
#define HOSTILE_STANCE_INSIDE    1
#define HOSTILE_STANCE_IDLE      2
#define HOSTILE_STANCE_TIRED     3
#define HOSTILE_STANCE_ALERT     4
#define HOSTILE_STANCE_ATTACK    5
#define HOSTILE_STANCE_ATTACKING 6
