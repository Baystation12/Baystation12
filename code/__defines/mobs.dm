...
#define APPEARANCE_PRONOUNS	FLAG(12)

#define APPEARANCE_COMMON (APPEARANCE_DNA2|APPEARANCE_RACE|APPEARANCE_GENDER|APPEARANCE_SKIN|APPEARANCE_ALL_HAIR|APPEARANCE_EYES|APPEARANCE_LANG|APPEARANCE_PRONOUNS)
...
// TODO: move to modpack
#define LANGUAGE_RESOMI			"Schechi"
#define SPECIES_RESOMI			"Resomi" // RESOMI DEFINE

#define SPECIES_TAJARA      "Tajara" // TAJARA DEFINE
#define LANGUAGE_SIIK_MAAS		"Siik'maas"
#define LANGUAGE_SIIK_TAJR		"Siik'tajr"


#define UNRESTRICTED_SPECIES list(SPECIES_HUMAN, SPECIES_DIONA, SPECIES_IPC, SPECIES_UNATHI, SPECIES_YEOSA, SPECIES_SKRELL, SPECIES_TRITONIAN, SPECIES_SPACER, SPECIES_VATGROWN, SPECIES_GRAVWORLDER, SPECIES_RESOMI, SPECIES_TAJARA, SPECIES_MULE) // Sierra edit (чо уж поделац)
