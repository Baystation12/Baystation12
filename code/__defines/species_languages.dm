...
#define HAS_SKIN_TONE          0x1    // Skin tone selectable in chargen. (0-220)
...
#define HAS_SKIN_TONE_GRAV     0x80   // Skin tone selectable in chargen (0-100)
#define HAS_SKIN_TONE_SPCR     0x100  // Skin tone selectable in chargen (0-165)
