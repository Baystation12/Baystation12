...
#define IC_ACTION_MOVEMENT		FLAG(0) // If the circuit can move the assembly
#define IC_ACTION_COMBAT		FLAG(1) // If the circuit can cause harm
#define IC_ACTION_LONG_RANGE	FLAG(2) // If the circuit communicate with something outside of the assembly
