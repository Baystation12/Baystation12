...
/datum/extension/deity_be_near/New(datum/holder, mob/living/deity/connect)
	..()
...
/datum/extension/deity_be_near/champion/deal_damage(mob/living/victim, mult)
	victim.adjustOxyLoss(3 * mult)

/datum/extension/deity_be_near/oracle/deal_damage(mob/living/victim, mult)
	victim.adjustFireLoss(mult)

/datum/extension/deity_be_near/traitor/deal_damage(mob/living/victim, mult)
