...
/datum/extension/interactive/multitool/radio/transmitter/aquire_target()
	...
	radio.transmit_on_change = radio.sanitize_events(actual_machine, radio.transmit_on_change)
	radio.transmit_on_tick = radio.sanitize_events(actual_machine, radio.transmit_on_tick)
...
/datum/extension/interactive/multitool/radio/event_transmitter/aquire_target()
	...
	if(!radio.is_valid_event(actual_machine, radio.event))
		radio.event = null
	radio.transmit_on_event = radio.sanitize_events(actual_machine, radio.transmit_on_event)
...
/datum/extension/interactive/multitool/radio/receiver/aquire_target()
	...
	radio.receive_and_call = radio.sanitize_events(actual_machine, radio.receive_and_call)
	radio.receive_and_write = radio.sanitize_events(actual_machine, radio.receive_and_write)
