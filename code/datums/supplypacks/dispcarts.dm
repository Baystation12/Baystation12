...
SEC_PACK(hydrochloric,   /obj/item/reagent_containers/chem_disp_cartridge/hydrochloric,    "Reagent refill - Hydrochloric Acid", "hydrochloric acid reagent cartridge crate", 15, access_chemistry)
...
SEC_PACK(acid,     /obj/item/reagent_containers/chem_disp_cartridge/acid,      "Reagent refill - Sulfuric Acid", "sulfuric acid reagent cartridge crate", 15, access_chemistry)
