...
/datum/category_item/underwear/undershirt/shirt_oak
	name = "Shirt, Orbital Assault Corps"
	icon_state = "marine_s"
...
/datum/category_item/underwear/undershirt/oac_female
	name = "Shirt, Orbital Assault Corps, Female"
