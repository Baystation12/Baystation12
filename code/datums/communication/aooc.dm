...
/decl/communication_channel/aooc/do_communicate(var/client/C, var/message)
	...
	for(var/client/target in GLOB.clients)
		if(target.holder)
			receive_communication(C, target, "<span class='ooc'><span class='aooc'>Antag-OOC: <EM>[get_options_bar(C, 0, 1, 1)]:</EM> <span class='message'>[message]</span></span></span>")
			...
			receive_communication(C, target, "<span class='ooc'><span class='aooc'>Antag-OOC: <EM>[player_display]:</EM> <span class='message'>[message]</span></span></span>")