...
/proc/register_all_movement(event_source, listener)
	GLOB.moved_event.register(event_source, listener, /atom/movable::recursive_move())
	GLOB.dir_set_event.register(event_source, listener, /atom::recursive_dir_set())

/proc/unregister_all_movement(event_source, listener)
	GLOB.moved_event.unregister(event_source, listener, /atom/movable::recursive_move())
	GLOB.dir_set_event.unregister(event_source, listener, /atom::recursive_dir_set())
