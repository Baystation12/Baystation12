...
/datum/weather
	...
	/// TRUE value protects areas with planetary_area marked as false, regardless of area type
	...
	var/overlay_layer = BASE_AREA_LAYER
	/// Plane for the overlay
	var/overlay_plane = DECAL_LAYER
...
/datum/weather/proc/telegraph()
	...
	for(var/V in affectareas)
		var/area/A = V
		if(protect_indoors && !A.planetary_surface)
			continue
