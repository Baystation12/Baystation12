/datum/uplink_item/item/deity/boon/ability_general
	category = /datum/uplink_category/deity_ability_general

/datum/uplink_item/item/deity/boon/ability_general/construct
...
/datum/uplink_item/item/deity/boon/ability_general/god_vision
	name = "Godsvision"
	desc = "Grants the ability for a servant to see the world like you do."
	item_cost = 20
	path = /spell/camera_connection/god_vision

/datum/uplink_item/item/deity/boon/ability_general/aura
	name = "Aura"
...
/datum/uplink_item/item/deity/boon/ability_general/shrine
	name = "Build Shrine"
