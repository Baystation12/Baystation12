...
/datum/sound_token/New(atom/source, sound_id, sound/sound, range = 4, prefer_mute = FALSE)
	...
	GLOB.destroyed_event.register(source, src, /datum::qdel_self())

	if(ismovable(source))
		proxy_listener = new(source, /datum/sound_token::PrivAddListener(), /datum/sound_token::PrivLocateListeners(), range, proc_owner = src)
...
/datum/sound_token/proc/Stop()
	...
	GLOB.destroyed_event.unregister(source, src, /datum::qdel_self())
...
/datum/sound_token/proc/PrivAddListener(atom/listener)
	...
	GLOB.moved_event.register(listener, src, /datum/sound_token::PrivUpdateListenerLoc())
	GLOB.destroyed_event.register(listener, src, /datum/sound_token::PrivRemoveListener())
...
/datum/sound_token/proc/PrivRemoveListener(atom/listener, sound/null_sound)
	...
	GLOB.moved_event.unregister(listener, src, /datum/sound_token::PrivUpdateListenerLoc())
	GLOB.destroyed_event.unregister(listener, src, /datum/sound_token::PrivRemoveListener())
	listeners -= listener
