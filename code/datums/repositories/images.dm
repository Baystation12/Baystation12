...
/repository/images/proc/atom_image(atom/holder, icon, icon_state, plane = FLOAT_PLANE, layer = FLOAT_LAYER)
	...
	if(!atom_cache_list)
		...
		GLOB.destroyed_event.register(holder, src, /repository/images::atom_destroyed())
...
/repository/images/proc/atom_destroyed(atom/destroyed)
	...
	GLOB.destroyed_event.unregister(destroyed, src, /repository/images::atom_destroyed())
