...
/obj/machinery/power/supermatter/bullet_act(var/obj/item/projectile/Proj)
	...
	if(Proj.flag != "bullet")
		if(istype(Proj, /obj/item/projectile/beam/supermatter_cutter))
			cutting_step++
			if(cutting_step >= cutting_step_max && cut_amount > 0)
				cut_amount--
				var/obj/item/sup_mat_shard/O = new/obj/item/sup_mat_shard
				O.loc = loc
				cutting_step = 0
			return
