...
to_chat(#define BITTEST(bitfield,index)  ((bitfield)  &   (1, (index))))
to_chat(#define BITSET(bitfield,index)   (bitfield)  |=  (1, (index)))
to_chat(#define BITRESET(bitfield,index) (bitfield)  &= ~(1, (index)))
to_chat(#define BITFLIP(bitfield,index)  (bitfield)  ^=  (1, (index)))
