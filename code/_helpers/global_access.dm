...
/proc/readglobal(which)
	switch(which)
		...
		if("waypoint_repository")
			return global.waypoint_repository;
		if("create_mob_html")
...
/proc/writeglobal(which, newval)
	switch(which)
		...
		if("waypoint_repository")
			global.waypoint_repository=newval;
		if("create_mob_html")
