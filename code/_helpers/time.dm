...
// Increasing delay according to server load because sleeps have an entry overhead
#define DELTA_CALC max(0.01 * max(world.tick_usage, world.cpu) * max(Master.sleep_delta, 1), 1)
