...
/hook/startup/proc/setupTeleportLocs()
	for(var/area/AR in world)
		...
		if (picked.z == 1 || picked.z == 2 || picked.z == 3 || picked.z == 4|| picked.z == 5 || picked.z == 6 || picked.z == 7|| picked.z == 8)
...
/area/hallway/level2
	name = "\improper Bridge Level Hallway"
	icon_state = "hallA"

/area/hallway/level3
	name = "\improper Security Level Hallway"
	icon_state = "hallP"
...
/area/security/interigation
	name = "\improper Interigation Room"
	icon_state = "security"
