...
/obj/item/weapon/paper/marooned/note02
	info = "Day 3. I done best I could to fix up my side, but I am not optimistic.<br>The dullness of this place is impossible. I think I forgot the word for 'pencil' yesterday. Will start writing this log to keep myself occupied. Just need to figure out what I can write without getting court-martialed when I get home."
/obj/item/weapon/paper/marooned/note03
	info = "Day 4. Saw some animals outside. Look pretty ferocious, and probably not edible. I'll stick to MREs for now.<br>I guess I'll start with how I ended up here. We were on a special mission far away from Magnitka, checking something for the Academy of Sciences, anomalous readings of some sorts. The professor looked pretty excited, but I didn't really understand the technical details. We got few scientists embedded in our crew, a civilian hull paintjob and 'alternative' transponder codes. Business as usual."
/obj/item/weapon/paper/marooned/note04
	info = "Day 5.<br>We got to the destination without much trouble. A planetoid, in uncharted sector of space. Scientists locked down on the readings they looked for, and we sent a team down. They returned with some sort of obelisk, etched with symbols I never saw before, maybe 3 meters tall. Should've ditched that thing out of airlock there and then."
/obj/item/weapon/paper/marooned/note05
	info = "Day 8. Made a running wave antenna and jury rigged some amplification for the radio. Hope someone will hears the signal.<br>That obelisk was trouble. People on guard duty in cargo hold kept complaining about headaches and hearing things. Some didn't. They were nice enough to offer to take shifts of those who complained. Now that I think about it, that's when they started acting weird."
