...
/datum/map/first_contact
	allowed_jobs = list(/datum/job/researcher,/datum/job/ODST,/datum/job/ODSTO,/datum/job/COMMO,/datum/job/IGUARD,/datum/job/colonist,/datum/job/ship_crew_civ,/datum/job/ship_cap_civ,/datum/job/ship_crew_innie,/datum/job/ship_cap_innie,/datum/job/unsc_ship_crew,/datum/job/unsc_ship_cap,/datum/job/covenant/kigyarpirate/captain,/datum/job/covenant/kigyarpirate,/datum/job/covenant/unggoy_deacon)
