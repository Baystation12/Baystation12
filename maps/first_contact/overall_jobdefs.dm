...
/datum/map/first_contact
	...
	allowed_spawns = list("Innie Crew","Corvette Crew","Civilian Ship Crew","Civ Ship Cap Crew","Research Facility Spawn","Kig-Yar Pirate Spawn","Research Facility Security Spawn","Research Facility Comms Spawn")
