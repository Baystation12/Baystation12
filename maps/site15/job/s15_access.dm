...
/* ACCESS REGIONS TO BE USED:
ACCESS_REGION_COMMAND
ACCESS_REGION_SECURITY
ACCESS_REGION_MEDBAY
ACCESS_REGION_RESEARCH
ACCESS_REGION_SUPPLY
ACCESS_REGION_ENGINEERING
ACCESS_REGION_GENERAL - Civilian and maintenance generally.

ACCESS_TYPE_NONE - USE THIS ONLY TO HIDE ACCESS FROM THE ID CARD PROGRAM!!!!!
*/

// Command Access //

/var/const/access_sitedirector = "ACCESS_SITEDIRECTOR"
/datum/access/sitedirector
	id = access_sitedirector
	desc = "Site Director's Office"
	region = ACCESS_REGION_COMMAND

/var/const/access_armories = "ACCESS_ARMORIES" // This is for the UNLOCK BUTTONS. Armories have no airlocks, just shutters/blastdoors.
/datum/access/armories
	id = access_armories
	desc = "Armories"
	region = ACCESS_REGION_COMMAND
...
/var/const/access_stations = "ACCESS_STATIONS" // Guard Stations - NOT Zone checkpoints.
/datum/access/stations
	id = access_stations
	desc = "Guard Stations"
	region = ACCESS_REGION_SECURITY

/var/const/access_checkpoints = "ACCESS_CHECKPOINTS" // ZONE CHECKPOINTS, NOT Guard Stations
/datum/access/checkpoints
	id = access_checkpoints
	desc = "Checkpoints"
	region = ACCESS_REGION_SECURITY
...
/datum/access/substations
	id = access_substations
	desc = "Substations"
	region = ACCESS_REGION_ENGINEERING

/var/const/access_maintenance = "ACCESS_MAINTENANCE" // Substations differ from regular maint access due to the possibility of cutting power inadvertently or grief.
/datum/access/maintenance
	id = access_maintenance
	desc = "Maintenance Tunnels"
	region = ACCESS_REGION_ENGINEERING
...
/var/const/access_freezer = "ACCESS_FREEZER"
/datum/access/freezer
	id = access_freezer
	desc = "EZ - Kitchen Freezer"
	region = ACCESS_REGION_GENERAL