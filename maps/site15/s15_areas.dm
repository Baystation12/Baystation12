...
// OUTSIDE - SINGULAR AREA.

/area/site15/external/outside
	name = "\improper Site External Areas"
	turf_initializer = /decl/turf_initializer/snow

// Entrance Zone - Sublevel

/area/site15/entrance_zone/sub/officeb
	name = "\improper EZ SUB - Communal Office B"
	icon_state = "reg_room"

/area/site15/entrance_zone/sub/canteen
	name = "\improper EZ SUB - Canteen"
	icon_state = "cafeteria"

/area/site15/entrance_zone/sub/bar
	name = "\improper EZ SUB - Canteen Bar"
	icon_state = "bar"
	req_access = list(access_bar)

/area/site15/entrance_zone/sub/kitchen
	name = "\improper EZ SUB - Canteen Kitchen"
	icon_state = "kitchen"
	req_access = list(access_kitchen)

/area/site15/entrance_zone/sub/freezer
	name = "\improper EZ SUB - Kitchen Freezer"
	icon_state = "freezer"
	req_access = list(access_freezer)

// Entrance Zone - Main

/area/site15/entrance_zone/main/cryogenics
	name = "\improper Cryogenic Storage"
	icon_state = "Sleep"

/area/site15/entrance_zone/main/canteenwalkway
	name = "\improper EZ ML - Canteen Upper Walkway"
	icon_state = "entrancezone"

/area/site15/entrance_zone/main/conferenceb
...
/area/site15/entrance_zone/second/sitediroff
	name = "\improper EZ SL - Site Director's Office"
	icon_state = "sitedir"
	req_access = list(access_sitedirector)

/area/site15/entrance_zone/second/adminoffices
	name = "\improper EZ SL - Admin Offices"
	icon_state = "entrancezone"

/area/site15/entrance_zone/second/conferencea
	name = "\improper EZ SL - Conference Room A"
	icon_state = "adminmeeting"

/area/site15/entrance_zone/second/janitor
	name = "\improper EZ SL - Janitor's Closet"
	icon_state = "janitor"
...
/area/site15/entrance_zone/security/second/station
	...
	icon_state = "adminsec"
	req_access = list(access_stations)

/area/site15/entrance_zone/security/second/armory
	name = "\improper EZ SL -  Admin Armory"
	icon_state = "armoryadmin"

// Entrance Zone - Engineering

/area/site15/entrance_zone/engineering/sub/substation
	name = "\improper EZ SUB -  Substation"
	icon_state = "substation"
	req_access = list(access_substations)

/area/site15/entrance_zone/engineering/main/substation
	name = "\improper EZ SL -  Substation"
	icon_state = "substation"
	req_access = list(access_substations)

/area/site15/entrance_zone/engineering/second/substation
	name = "\improper EZ SL -  Substation"
	icon_state = "substation"
	req_access = list(access_substations)
...
/area/site15/entrance_zone/maintenance
...
/area/site15/entrance_zone/maintenance/main/canteencryomaint
	name = "\improper EZ ML - Canteen / Cryo Maintenance"

/area/site15/entrance_zone/maintenance/sub/canteenofficebmaint
	name = "\improper EZ SUB - Canteen / Office B Maintenance"

// Entrance Zone - Medical

/area/site15/entrance_zone/medical/second/station
	name = "\improper EZ SL -  Admin First Aid Station"
	icon_state = "firstaidadmin"