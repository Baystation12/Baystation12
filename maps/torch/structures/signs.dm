...
/obj/structure/sign/ecplaque/grab_attack(obj/item/grab/G)
	...
	admin_attack_log(G.assailant, G.affecting, "educated victim on \the [src].", "Was educated on \the [src].", "used \a [src] to educate")
	G.force_drop()
	return TRUE
...
/obj/structure/sign/memorial/use_item(var/obj/D, var/mob/user)
