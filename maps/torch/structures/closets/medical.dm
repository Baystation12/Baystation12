...
/obj/structure/closet/secure_closet/medical_torch/coordinator
	name = "First Response Coordinator's locker"


/obj/structure/closet/secure_closet/medical_torch/coordinator/WillContain()
	var/list/coord = ..()
	coord += /obj/item/device/megaphone
	return coord