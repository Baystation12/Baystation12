...
/datum/gear/accessory/black_vest
	...
	cost = 3
	allowed_roles = list(/datum/job/hos, /datum/job/warden, /datum/job/forensic_tech, /datum/job/detective, /datum/job/officer, /datum/job/guard, /datum/job/merchant)
