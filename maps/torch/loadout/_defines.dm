...
//For contractors
#define CONTRACTOR_ROLES list(/datum/job/engineer_contractor, /datum/job/roboticist, /datum/job/doctor_contractor, /datum/job/psychiatrist, /datum/job/cargo_contractor, /datum/job/bartender, /datum/job/chef, /datum/job/janitor, /datum/job/detective)
...
#define RESTRICTED_ROLES list(/datum/job/assistant, /datum/job/bartender, /datum/job/detective, /datum/job/merchant, "Off-Duty", /datum/job/stowaway)
...
#define SECURITY_ROLES list(/datum/job/hos, /datum/job/warden, /datum/job/forensic_tech, /datum/job/detective, /datum/job/officer)
...
#define ARMED_ROLES list(/datum/job/captain, /datum/job/hop, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos, /datum/job/sea, /datum/job/officer, /datum/job/warden, /datum/job/forensic_tech, /datum/job/detective, /datum/job/guard, /datum/job/merchant)

//For jobs that spawn with armor in their lockers
#define ARMORED_ROLES list(/datum/job/captain, /datum/job/hop, /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos, /datum/job/qm, /datum/job/sea, /datum/job/bridgeofficer, /datum/job/solgov_pilot, /datum/job/officer, /datum/job/warden, /datum/job/forensic_tech, /datum/job/detective, /datum/job/guard, /datum/job/merchant)
