...
/datum/ai_laws/exo_synth/New()
	...
	add_inherent_law("Вы не можете вступать в бой ни при каких условиях, за исключением самозащиты. Ваше самосохранение на первом месте, но вы не можете использовать оружие дальнего боя.")
