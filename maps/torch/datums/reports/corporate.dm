...
/datum/computer_file/report/recipient/corp/incident/generate_fields()
	...
	set_access(list(list(access_heads, access_representative, access_senadv)), list(list(access_heads, access_representative, access_senadv)))
