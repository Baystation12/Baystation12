...
/datum/antagonist/changeling
	...
	protected_jobs = list(/datum/job/engineer_trainee)
...
/datum/antagonist/loyalists
	...
	protected_jobs = list(/datum/job/officer, /datum/job/engineer_trainee)
...
/datum/antagonist/traitor
	blacklisted_jobs = list(/datum/job/merchant, /datum/job/captain, /datum/job/hop, /datum/job/ai, /datum/job/submap, /datum/job/hos, /datum/job/engineer_trainee)
