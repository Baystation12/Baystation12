/datum/map/torch
	...
	apc_test_exempt_areas = list(
		...
		/area/maintenance/torch/auxsolarbridge = NO_SCRUBBER,
		/area/maintenance/torch/auxsolarport = NO_SCRUBBER,
		/area/maintenance/torch/auxsolarstarboard = NO_SCRUBBER,
		/area/maintenance/torch/exterior = NO_SCRUBBER|NO_VENT|NO_APC,
		/area/maintenance/torch/firstdeck/foreport = NO_SCRUBBER,
		/area/maintenance/torch/firstdeck/forestarboard = NO_SCRUBBER,
		/area/maintenance/torch/fourthdeck/aft = 0,
		/area/maintenance/torch/incinerator = NO_SCRUBBER,
		/area/maintenance/torch/seconddeck/aftport = NO_SCRUBBER,
		/area/maintenance/torch/seconddeck/forestarboard = NO_SCRUBBER,
		/area/maintenance/torch/thirddeck/aftstarboard = NO_SCRUBBER,
