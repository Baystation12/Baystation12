...
/obj/item/clothing/suit/storage/terran/service/navy
	name = "terran coat"
	desc = "A TCC Navy service coat. Black and undecorated."
	icon_state = "terranservice"
	item_state = "terranservice"

/obj/item/clothing/suit/storage/terran/service/navy/command
	name = "terran command coat"
	desc = "A TCC Navy service command coat. White and undecorated."
...
/obj/item/clothing/suit/dress/terran/navy
	name = "terran dress cloak"
	desc = "A black TCC Navy dress cloak with red detailing. So sexy it hurts."
	icon_state = "terrandress"
	item_state = "terrandress"

/obj/item/clothing/suit/dress/terran/navy/officer
	name = "terran officer's dress cloak"
	desc = "A black TCC Navy dress cloak with gold detailing. Smells like ceremony."
	icon_state = "terrandress_off"
	item_state = "terrandress_off"

/obj/item/clothing/suit/dress/terran/navy/command
	name = "terran command dress cloak"
	desc = "A black TCC Navy dress cloak with royal detailing. Smells like ceremony."
