...
/obj/item/clothing/head/beret/solgov/fleet/branch
	name = "TF73 beret"
	desc = "A Beret denoting service in the fleet. It has the Insignia of Task Force 73 upon it."
	icon_state = "beret_navy_first"

/obj/item/clothing/head/beret/solgov/fleet/branch/second
	name = "11th AC Beret"
	desc = "A Beret denoting service in the fleet. It has the Insignia of the 11th Assault Corps on it."
	icon_state = "beret_navy_second"

/obj/item/clothing/head/beret/solgov/fleet/branch/third
	name = "1st SF Beret"
	desc = "A Beret denoting service in the fleet. It has the insignia of the 1st Surveyor Fleet on it."
	icon_state = "beret_navy_third"

/obj/item/clothing/head/beret/solgov/fleet/branch/fourth
	name = "214th SOG Beret"
	desc = "A Beret denoting service in the fleet. It has the insignia of the 214th Special Operations Group on it."
	icon_state = "beret_navy_fourth"

/obj/item/clothing/head/beret/solgov/fleet/branch/fifth
	name = "Lucky 7th Beret"
	desc = "A Beret denoting service in the fleet. IT has the insignia of the ''Lucky'' 7th Fleet on it."
