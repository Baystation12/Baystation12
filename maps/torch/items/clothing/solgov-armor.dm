/obj/item/clothing/suit/armor/vest/solgov
	name = "\improper Terran Defence Force armored vest"
	desc = "A synthetic armor vest. This one is marked with the crest of the Terran Defence Force."
	icon_state = "solvest"
...
/obj/item/clothing/suit/storage/vest/solgov/command
	...
	desc = "A synthetic armor vest with TERRAN DEFENCE FORCE printed in gold lettering on the chest. This one has added webbing and ballistic plates."
	icon_state = "comwebvest"

/obj/item/clothing/suit/armor/pcarrier/blue/sol
	name = "peacekeeper plate carrier"
	desc = "A lightweight plate carrier vest in TDF Peacekeeper colors. It can be equipped with armor plates, but provides no protection of its own."
