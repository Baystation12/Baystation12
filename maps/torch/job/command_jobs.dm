...
/datum/job/hop
	...
	access = list(
		...
		access_explorer, access_pathfinder, access_pilot, access_commissary, access_collins, access_collins_helm, access_collins_analysis, access_collins_phoron,
		access_collins_toxins, access_collins_chemistry, access_collins_security, access_collins_maint, access_rd, access_collins_rd, access_torch_fax, access_torch_helm,
...
/datum/job/rd
	...
	access = list(
		...
		access_collins_analysis, access_collins_phoron, access_collins_toxins, access_collins_chemistry, access_collins_rd,
		access_collins_security, access_collins_maint, access_pathfinder, access_explorer, access_eva, access_solgov_crew,
