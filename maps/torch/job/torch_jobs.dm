/datum/map/torch
	species_to_job_whitelist = list(
		...
		/datum/species/human/mule = list(/datum/job/ai, /datum/job/cyborg, /datum/job/merchant,/datum/job/janitor, /datum/job/cargo_tech, /datum/job/chef, /datum/job/mining,
		 								  /datum/job/engineer_trainee, /datum/job/assistant, /datum/job/bartender, /datum/job/medical_trainee,
