...
/datum/job/rd/get_description_blurb()
	return "You are the Research Director. You are responsible for the research department. You handle both the science part of the mission but are also responsible for ensuring the corporate interests of Tenjin Holdings are fulfilled, along with your Corporate Liaison. Make sure science gets done, do some yourself, and get your scientists on away missions to find things to benefit your employer. Don't put Tenjin Holdings', or your employer's, position onboard in jeopardy.  Advise the CO on science matters."
...
/datum/job/liaison
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "Corporate Regulations, the Union Charter, and Tenjin Holdings"
