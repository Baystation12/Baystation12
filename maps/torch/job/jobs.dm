...
/datum/job/hop
	...
	access = list(access_security, access_brig, access_armory, access_forensics_lockers,
			            ...
			            access_seneng, access_senmed, access_senadv, access_hangar, access_guppy_helm, access_expedition_shuttle_helm, access_explorer, access_pathfinder, access_gunlockers)
	minimal_access = list(access_security, access_brig, access_armory, access_forensics_lockers,
			            ...
			            access_hop, access_hos, access_RC_announce, access_keycard_auth, access_tcomsat, access_gateway, access_sec_doors, access_psychiatrist,
			            access_medical_equip, access_solgov_crew, access_robotics_engineering, access_emergency_armory, access_gun, access_expedition_shuttle, access_guppy,
			            access_seneng, access_senmed, access_senadv, access_hangar, access_guppy_helm, access_aquila, access_explorer, access_pathfinder, access_gunlockers)
...
/datum/job/rd
	...
	access = list(access_tox, access_tox_storage, access_emergency_storage, access_teleporter, access_heads, access_rd,
						...
						access_expedition_shuttle, access_guppy, access_hangar, access_petrov, access_petrov_helm, access_guppy_helm, access_gunlockers)
	minimal_access = list()
...
/datum/job/cmo
	...
	access = list(access_medical, access_morgue, access_maint_tunnels, access_external_airlocks, access_emergency_storage,
			            ...
			            access_medical_equip, access_solgov_crew, access_senmed, access_gunlockers)
	minimal_access = list()
...
/datum/job/chief_engineer
	...
	access = list(access_engine, access_engine_equip, access_maint_tunnels, access_external_airlocks, access_emergency_storage,
			            ...
			            access_solgov_crew, access_robotics_engineering, access_seneng, access_hangar, access_robotics, access_gunlockers)
...
/datum/job/hos
	...
	access = list(access_security, access_brig, access_armory, access_forensics_lockers,
			            ...
			            access_solgov_crew, access_gun, access_gunlockers)
	minimal_access = list()
...
/datum/job/sea
	...
	access = list(access_security, access_medical, access_engine, access_maint_tunnels, access_external_airlocks, access_emergency_storage,
			            ...
			            access_solgov_crew, access_gun, access_expedition_shuttle, access_guppy, access_senadv, access_hangar, access_emergency_armory, access_gunlockers)
...
/datum/job/bridgeofficer
	...
	access = list(access_security, access_medical, access_engine, access_maint_tunnels, access_emergency_storage,
			            ...
			            access_solgov_crew, access_gunlockers)
...
/datum/job/solgov_pilot
	...
	access = list(access_maint_tunnels, access_external_airlocks, access_eva, access_emergency_storage, access_solgov_crew, access_aquila, access_aquila_helm,
						access_expedition_shuttle, access_expedition_shuttle_helm, access_guppy, access_guppy_helm, access_hangar, access_solgov_crew, access_heads, access_explorer, access_gunlockers, access_cent_creed) //Yes, the last one is weird. It's used to make intercoms work.
...
/datum/job/pathfinder
	...
	access = list(access_pathfinder, access_explorer, access_eva, access_maint_tunnels, access_heads, access_emergency_storage, access_tech_storage, access_guppy_helm, access_solgov_crew, access_expedition_shuttle, access_guppy, access_hangar, access_cent_creed, access_gunlockers)
...
/datum/job/qm
	...
	access = list(access_maint_tunnels, access_heads, access_emergency_storage, access_tech_storage,  access_cargo, access_guppy_helm,
						access_cargo_bot, access_qm, access_mailsorting, access_solgov_crew, access_expedition_shuttle, access_guppy, access_hangar, access_gunlockers)
	minimal_access = list()
