/datum/map/torch
	species_to_job_whitelist = list(
		...
		/datum/species/human/uplift = list(/datum/job/ai, /datum/job/cyborg, /datum/job/janitor,
			/datum/job/scientist_assistant, /datum/job/roboticist, /datum/job/psychiatrist,
			/datum/job/cargo_contractor, /datum/job/nt_pilot, /datum/job/mining, /datum/job/assistant,
			/datum/job/chef, /datum/job/engineer_contractor, /datum/job/doctor_contractor, /datum/job/bartender,
			/datum/job/stowaway)
	)
