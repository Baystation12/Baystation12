/datum/map/cadulus
	name = "Cadulus"
	full_name = "IEV Cadulus"
	path = "cadulus"
	flags = MAP_HAS_BRANCH

	lobby_icon = 'maps/cadulus/icons/lobby.dmi'
	...
	usable_email_tlds = list("mail.cadulus.tu", "rsc.cadulus.tu", "freemail.nt")

	allowed_spawns = list("Cryogenic Storage", "Cyborg Storage")
	default_spawn = "Cryogenic Storage"

	station_name  = "IEV Cadulus"
	station_short = "Cadulus"
	dock_name     = "TBD"
	boss_name     = "IEV Cadulus"
	boss_short    = "Cadulus"
	company_name  = "The Benefactor"
	company_short = "Benefactor"

	map_admin_faxes = list("The Benefactor")

	//These should probably be moved into the evac controller...
	shuttle_docked_message = "All hands: Secure your stations and tie down all loose cargo. Time to jump: approximately %ETD%."
	shuttle_leaving_dock = "All hands: We've made the jump to bluespace, we will complete transit in %ETA%."
	shuttle_called_message = "All hands: Bluespace jump procedures initiated. The bluespace drive has begun spooling up. Jump in %ETA%."
	shuttle_recall_message = "All hands: Jump procedures aborted, return to your stations."

	evac_controller_type = /datum/evacuation_controller/starship

	default_law_type = /datum/ai_laws/cadulus
	use_overmap = 1
...
/datum/map/torch/send_welcome()
	var/welcome_text = "<center><font size = 3><b>[GLOB.using_map.ship_name]</b> Sensor Readings:</font><hr />"
	...
	post_comm_message("[GLOB.using_map.ship_name] Sensor Readings", welcome_text)
	minor_announcement.Announce(message = "New [GLOB.using_map.ship_name] Update available at all communication consoles.")
