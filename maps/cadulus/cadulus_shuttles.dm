...
/datum/shuttle/autodock/ferry/escape_pod/shippod
	category = /datum/shuttle/autodock/ferry/escape_pod/shippod
	sound_takeoff = 'sound/effects/rocket.ogg'
	sound_landing = 'sound/effects/rocket_backwards.ogg'
	var/number

/datum/shuttle/autodock/ferry/escape_pod/shippod/New()
...
/datum/shuttle/autodock/ferry/escape_pod/shippod/escape_pod6
	warmup_time = 10
...
/datum/shuttle/autodock/multi/antag/mercenary
	name = "Mercenary"
	warmup_time = 0
	destinations = list("nav_merc_dock", "nav_merc_start")
