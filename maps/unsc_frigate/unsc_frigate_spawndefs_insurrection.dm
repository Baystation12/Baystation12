...
/datum/map/unsc_frigate
	allowed_jobs = list(/datum/job/Insurrectionist,/datum/job/Insurrectionist_leader,/datum/job/UNSC_ship/commander,/datum/job/UNSC_ship/exo,\
...
/datum/job/UNSC_ship/technician_chief,/datum/job/UNSC_ship/technician)
	allowed_spawns = list("UNSC Frigate Spawn","Insurrectionist","Insurrectionist Leader")
