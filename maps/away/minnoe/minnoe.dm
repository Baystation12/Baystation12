...
/obj/overmap/visitable/sector/minnoe
	...
	initial_restricted_waypoints = list(
		...
		"Guppy" = list("nav_minnoe_gup", "nav_minnoe_gup/alt", "nav_minnoe_gup/alt/hatch"),
		"Aquila" = list("nav_minnoe_aquila", "nav_minnoe_aquila/alt"),
...
/area/map_template/minnoe/FPEskiff
	name = "\improper Courage of Earhart"
	icon_state = "fpeskiff"
...
/obj/shuttle_landmark/minnoe/generic/
...
/obj/shuttle_landmark/minnoe/generic/west
	name = "North-West of Asteroid Station"
