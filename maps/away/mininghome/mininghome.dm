...
/obj/effect/shuttle_landmark/nav_mininghome/guppy
	name = "Hangar"
	landmark_tag = "nav_mininghome_4"
	base_area = /area/map_template/mininghome
	base_turf = /turf/simulated/floor/plating

/obj/effect/shuttle_landmark/nav_mininghome/nav1
	name = "Navpoint #1"
	landmark_tag = "nav_mininghome_1"

/obj/effect/shuttle_landmark/nav_mininghome/nav2
	name = "Navpoint #2"
	landmark_tag = "nav_mininghome_2"

/obj/effect/shuttle_landmark/nav_mininghome/nav3
	name = "Navpoint #3"
...
/area/map_template/mininghome
	name = "\improper Hangar"
	icon_state = "hangar"

/area/map_template/mininghome/lockers
	name = "\improper Break Room"
	icon_state = "locker"

/area/map_template/mininghome/bathroom
	name = "\improper bathroom"
	icon_state = "toilet"

/area/map_template/mininghome/mess
	name = "\improper Mess Hall"
	icon_state = "kitchen"

/area/map_template/mininghome/hall
	name = "\improper Skybridge Hall"
	icon_state = "Tactical"

/area/map_template/mininghome/power
	name = "\improper Engineering and Atmos"
	icon_state = "disperser"

/area/map_template/mininghome/living
	name = "\improper Living Quarters"
	icon_state = "Holodeck"

/area/map_template/mininghome/living1
	name = "\improper Living Quarters"
	icon_state = "sauna"

/area/map_template/mininghome/robotics
	name = "\improper Robotics"
	icon_state = "bar"

/area/map_template/mininghome/solars
	name = "\improper Solars"
	icon_state = "eva"

// Torch only items off torch

/obj/item/iccg_passport_old
...
/obj/item/clothing/head/beret/mininghome
...
/obj/item/clothing/head/beret/mininghome/sol
