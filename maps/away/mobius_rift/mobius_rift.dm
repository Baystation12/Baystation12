...
/obj/effect/step_trigger/mobius_rift/seamless_portal/Initialize(var/loc, var/towards)
	. = ..()
	if (towards == NORTH)
		y_shift = 1
	if (towards == SOUTH)
...
/obj/effect/step_trigger/mobius_rift/seamless_portal/Trigger(A)
	if (!ismovable(A))
		return
...
/obj/effect/mobius_rift/chamber/Initialize(var/loc, var/grid_size)//NORTH, SOUTH, EAST, WEST
	. = ..()
	var/turf/T
