...
/datum/gear/uniform/settler
	display_name = "settler's clothes selection"
	path = /obj/item/clothing/under/fallout/settler

/datum/gear/uniform/settler/New()
	..()
	var/sclothes = list()
	sclothes["plaid shirt"] = /obj/item/clothing/under/fallout/lumberjack
	sclothes["brown rancher clothes"] = /obj/item/clothing/under/fallout/cowboyb
	sclothes["grey rancher clothes"] = /obj/item/clothing/under/fallout/cowboyg
	sclothes["baseball jersey"] = /obj/item/clothing/under/fallout/batter
	sclothes["relaxed wear"] = /obj/item/clothing/under/fallout/relaxed
	sclothes["spring wear"] = /obj/item/clothing/under/fallout/spring
	sclothes["brahmin leather clothes (M)"] = /obj/item/clothing/under/fallout/brahminm
	sclothes["brahmin leather clothes (F)"] = /obj/item/clothing/under/fallout/brahminf
	sclothes["mercenary clothes (M)"] = /obj/item/clothing/under/fallout/mercam
	sclothes["mercenary clothes (F)"] = /obj/item/clothing/under/fallout/mercaf
	sclothes["jailbird clothes (M)"] = /obj/item/clothing/under/fallout/merccm
	sclothes["jailbird clothes (F)"] = /obj/item/clothing/under/fallout/merccf
	sclothes["wanderer's clothes"] = /obj/item/clothing/under/fallout/roving
	gear_tweaks += new/datum/gear_tweak/path(sclothes)