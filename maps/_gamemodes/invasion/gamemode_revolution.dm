...
/datum/game_mode/outer_colonies/revolution
	...
	overmap_hide = list(/obj/effect/overmap/sector/exo_research, /obj/effect/overmap/sector/exo_listen, /obj/effect/overmap/ship/soe_osprey, /obj/effect/overmap/ship/covenant_light_cruiser)
