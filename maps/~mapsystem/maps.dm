...
/datum/map
	...
	var/list/available_cultural_info = list(
		...
		TAG_CULTURE = list(
			...
			CULTURE_HUMAN_GAIAN,
			CULTURE_HUMAN_OTHER,
			CULTURE_HUMAN_LORRIMAN, //PRX
			CULTURE_HUMAN_AVANOBLE, //PRX
			CULTURE_HUMAN_AVACOMMON, //PRX
			CULTURE_OTHER
		),
		TAG_RELIGION = list(
			RELIGION_UNSTATED,
