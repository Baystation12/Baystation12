...
/datum/map/overmap_example/map_info(victim)
	to_chat(victim, "You're aboard <b>[station_name]</b> an independant vessel affiliated with Free Trade Union, on a SPACE FRONTIER. No major corporation or government has laid claims on planets in this sector, so their exploitation is entirely up to you - mine, poach and deforest all you want.")
