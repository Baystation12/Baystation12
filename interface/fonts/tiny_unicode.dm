...
/// px sizing is pt / 0.75. 12pt = 16px, 24pt = 32px etc.

/// From https://www.dafont.com/tinyunicode.font
/// Created by DuffsDevice
/singleton/font/tiny_unicode
	name = "TinyUnicode"
...
/singleton/font/tiny_unicode/size_12pt
