...
/obj/effect/computer_file_creator/event1/Initialize()
...
/obj/effect/computer_file_creator/event2/Initialize()
	file_name = "crashreport_316-93-09-08-2312"
	file_info = "FLOPLOGDUMP0909432ERR\
\...DATA CORRUPTED\
\...PARTIAL RETRIEVAL\
\
...
/obj/effect/computer_file_creator/event3/Initialize()
	file_name = "DOORSYSLOG-3034"
	file_info = "\[b]Airlock Anomalies Report[/b][hr]Midship Airlock Error Detected\
\
...
/obj/effect/computer_file_creator/event4/Initialize()
	file_name = "01000011 01001111 01001101 01001101 01001100 01001111 01000111 00110000 00110100"
	file_info = "[b]SHIPCOMM DATASHEET[/b][hr]ERROR IN DATA RETRIEVAL, OUTPUTTING REMAINING DATA...\
\...\
\...\
\...\
\
...
/obj/effect/computer_file_creator/event5/Initialize()
	file_name = "MEDSENS003"
	file_info = "\[b]VITAL LIFESIGN TRACKING[/b][hr]00:00 All Crew Nominal\
\
...
/obj/effect/computer_file_creator/event6/Initialize()
	file_name = "FLTDC-315"
	file_info = "\[center][b]Sol Central Government Fleet Official Document[/b]\
\[i]SFV Jonah[/i]\
\
\[fleetlogo]\
\
